...
| **chezmoi** | 2.66.0 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **clvk** | 0.0.20251004.105545 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
...
| **cmus** | 2.12.0-5 | Small, fast and powerful console music player | https://cmus.github.io/ |
...
| **command-not-found** | 3.1-16 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **fetchmail** | 6.5.6 | A remote-mail retrieval utility | https://www.fetchmail.info/ |
| **fetchmailconf** | 6.5.6 | A GUI configurator for generating fetchmail configuration files | https://www.fetchmail.info/ |
| **fff** | 2.2 | A simple file manager written in bash | https://github.com/dylanaraps/fff |
| **ffmpeg** | 7.1.1-7 | Tools and libraries to manipulate a wide range of multimedia formats and protocols | https://ffmpeg.org |
...
| **fish** | 4.1.0 | The user-friendly command line shell | https://fishshell.com/ |
...
| **graphviz** | 14.0.1 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 14.0.1 | Static libraries for graphviz | https://www.graphviz.org/ |
...
| **hugo** | 0.151.0 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **imagemagick** | 7.1.2.5-1 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.2.5-1 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **jackett** | 0.24.131 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jfrog-cli** | 2.80.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **k9s** | 0.50.15 | Kubernetes CLI To Manage Your Clusters In Style! | https://k9scli.io |
...
| **libcompiler-rt** | 21.1.3-1 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libllvm** | 21.1.3-1 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 21.1.3-1 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **liblo** | 0.33 | A lightweight library that provides an easy to use implementation of the OSC protocol | https://liblo.sourceforge.net/ |
| **liblo-static** | 0.33 | Static libraries for liblo | https://liblo.sourceforge.net/ |
...
| **libpolly** | 21.1.3-1 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **lld** | 21.1.3-1 | LLVM-based linker | https://clang.llvm.org/ |
| **lldb** | 21.1.3-1 | LLVM-based debugger | https://clang.llvm.org/ |
| **llvm** | 21.1.3-1 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
...
| **llvm-tools** | 21.1.3-1 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 21.1.3-1 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **mediamtx** | 1.15.2 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **mesa** | 25.2.4 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 25.2.4 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-opencl-icd-rusticl** | 25.2.4 | Mesa's Rusticl OpenCL ICD | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 25.2.4 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **mlir** | 21.1.3-1 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
...
| **msedit** | 1.2.0 | A simple editor for simple needs (Microsoft Edit) | https://github.com/microsoft/edit |
...
| **mympd** | 22.1.1 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **nushell** | 0.107.0-3 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **oh-my-posh** | 27.2.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **openlist** | 4.1.4 | A file list program that supports multiple storage | https://oplist.org/ |
...
| **pocketbase** | 0.30.2 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **pv** | 1.9.42 | Terminal-based tool for monitoring the progress of data through a pipeline | https://www.ivarch.com/programs/pv.shtml |
...
| **pygobject** | 3.54.3 | Python package which provides bindings for GObject based libraries | https://pygobject.gnome.org/ |
...
| **python-cryptography** | 46.0.2 | Provides cryptographic recipes and primitives to Python developers | https://github.com/pyca/cryptography |
...
| **python-ruff** | 0.14.0 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **ruff** | 0.14.0 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **sccache** | 0.11.0 | sccache is ccache with cloud storage | https://github.com/mozilla/sccache |
...
| **shaderc** | 2025.4 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **sing-box** | 1.12.10 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **swi-prolog** | 9.3.32 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **uv** | 0.9.2 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vtm** | 2025.10.14 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **vulkan-headers** | 1.4.329 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.329 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.329 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.329 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
| **vulkan-validation-layers** | 1.4.329 | Vulkan Validation Layers | https://github.com/KhronosGroup/Vulkan-ValidationLayers |
...
| **zrok** | 1.1.8 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
