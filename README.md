...
| **biome2** | 2.4.15 | A toolchain for web projects, aimed to provide functionalities to maintain them. Biome offers formatter and linter, usable via CLI and LSP | https://biomejs.dev/ |
...
| **cloudflared** | 2026.5.1 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **dnscontrol** | 4.39.0 | Infrastructure as code for DNS! | https://github.com/StackExchange/dnscontrol |
...
| **glab-cli** | 1.99.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **moor** | 2.13.2 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
