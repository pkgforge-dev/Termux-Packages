...
| **7zip** | 26.02-2 | 7-Zip file archiver with a high compression ratio | https://www.7-zip.org |
...
| **aapt** | 16.0.0.4-1 | Android Asset Packaging Tool | https://github.com/termux/android-build-tools |
| **aapt2** | 16.0.0.4-1 | AAPT2 (Android Asset Packaging Tool) | https://github.com/termux/android-build-tools |
...
| **aidl** | 16.0.0.4-1 | Android Interface Definition Language (AIDL) | https://github.com/termux/android-build-tools |
...
| **algernon** | 1.17.11 | Small self-contained web server with Lua, Markdown, QUIC, Redis and PostgreSQL support | https://algernon.roboticoverlords.org/ |
| **alpine** | 2.26-1 | Fast, easy to use email client | http://alpine.x10host.com/ |
| **alsa-lib** | 1.2.16.1 | The Advanced Linux Sound Architecture (ALSA) - library | https://www.alsa-project.org |
| **alsa-plugins** | 1.2.12-1 | The Advanced Linux Sound Architecture (ALSA) - plugins | https://www.alsa-project.org |
| **alsa-utils** | 1.2.16 | The Advanced Linux Sound Architecture (ALSA) - utils | https://www.alsa-project.org |
...
| **android-tools** | 36.0.1+really35.0.2 | Android platform tools | https://developer.android.com/ |
...
| **apr-util-static** | 1.6.5 | Static libraries for apr-util | https://apr.apache.org/ |
...
| **artalk** | 2.10.0 | A self-hosted comment system | https://artalk.js.org/ |
...
| **asciidoc** | 10.2.1-3 | Text document format for short documents, articles, books and UNIX man pages. | https://asciidoc.org |
...
| **awscli** | 2.36.24 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **bash** | 5.3.15 | A sh-compatible shell that incorporates useful features from the Korn shell (ksh) and C shell (csh) | https://www.gnu.org/software/bash/ |
...
| **bear** | 4.2.0 | Bear is a tool that generates a compilation database for clang tooling. | https://github.com/rizsotto/Bear |
...
| **biome2** | 2.5.8 | A toolchain for web projects, aimed to provide functionalities to maintain them. Biome offers formatter and linter, usable via CLI and LSP | https://biomejs.dev/ |
...
| **boost-headers** | 1:1.91.0 | Boost header files | https://boost.org |
...
| **brogue** | 1.15.1-1 | Roguelike dungeon crawling game (community edition) | https://sites.google.com/site/broguegame/ |
...
| **broot** | 1.58.0 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **byobu** | 7.17 | Byobu is a GPLv3 open source text-based window manager and terminal multiplexer | https://www.byobu.org/ |
...
| **cabal-install** | 3.16.1.0-1 | The command-line interface for Haskell-Cabal and Hackage | https://www.haskell.org/cabal/ |
...
| **cargo-binstall** | 1.21.1 | Tool to fetch and install precompiled musl-based static binaries from the Rust ecosystem | https://github.com/cargo-bins/cargo-binstall |
| **cargo-c** | 0.10.24 | Cargo C-ABI helpers | https://github.com/lu-zero/cargo-c |
...
| **catch2** | 3.15.3 | A modern, C++-native, header-only, framework for unit-tests, TDD and BDD | https://github.com/catchorg/catch2 |
| **catch2-static** | 3.15.3 | Static libraries for catch2 | https://github.com/catchorg/catch2 |
...
| **cava** | 1.0.0 | Console-based Audio Visualizer. Works with MPD and Pulseaudio | https://github.com/karlstav/cava |
| **cavez-of-phear** | 0.6.2 | A Boulder Dash like game for consoles/terminals | https://github.com/AMDmi3/cavezofphear |
| **cavif** | 1.6.0 | AVIF image creator in pure Rust | https://lib.rs/cavif |
...
| **cec-client** | 8.1.6 | Client applications for libCEC | https://libcec.pulse-eight.com/ |
...
| **chezmoi** | 2.72.0 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **command-not-found** | 3.5.0-6 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **cookcli** | 0.32.1 | A suite of tools to create shopping lists and maintain food recipes | https://cooklang.org |
...
| **cppcheck** | 2.21.1 | tool for static C/C++ code analysis | https://github.com/danmar/cppcheck |
...
| **cpptrace** | 1.0.4 | Self-contained stacktrace library for C++11 and newer | https://github.com/jeremy-rifkin/cpptrace |
...
| **croc** | 1:11.1.0 | Easily and securely send things from one computer to another | https://github.com/schollz/croc |
...
| **curl** | 8.21.0 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **dart** | 3.13.0 | Dart is a general-purpose programming language | https://dart.dev/ |
...
| **db** | 18.1.40-6 | The Berkeley DB embedded database system | https://www.oracle.com/database/berkeley-db |
| **dbus** | 1.16.2-3 | Freedesktop.org message bus system | https://dbus.freedesktop.org |
| **dbus-python** | 1.4.0-3 | Python bindings for D-Bus | https://dbus.freedesktop.org/doc/dbus-python/ |
...
| **deno** | 1:2.9.4 | A modern runtime for JavaScript and TypeScript | https://deno.land/ |
...
| **discordo** | 2026.08.07+g89513df8 | A lightweight, secure, and feature-rich Discord terminal client | https://github.com/ayn2op/discordo |
...
| **dnscontrol** | 4.46.0 | Infrastructure as code for DNS! | https://github.com/StackExchange/dnscontrol |
...
| **dnsutils** | 9.20.26 | Clients provided with BIND | https://www.isc.org/bind/ |
...
| **dos2unix** | 7.5.6 | Converts between DOS and Unix text files | https://waterlander.net/dos2unix/ |
...
| **dropbear** | 2026.94 | Small SSH server and client | https://matt.ucc.asn.au/dropbear/dropbear.html |
...
| **dua** | 2.42.1 | View disk space usage and delete unwanted data, fast | https://github.com/Byron/dua-cli |
...
| **erlang** | 29.0.5 | General-purpose concurrent functional programming language | https://www.erlang.org/ |
| **erlang-doc** | 29.0.5 | Erlang HTML documentation | https://www.erlang.org/ |
| **esbuild** | 0.28.2 | An extremely fast JavaScript bundler | https://esbuild.github.io/ |
...
| **et** | 7.0.0 | A remote shell that automatically reconnects without interrupting the session | https://eternalterminal.dev |
...
| **exfatprogs** | 1.4.3 | exFAT filesystem userspace utilities | https://github.com/exfatprogs/exfatprogs |
...
| **fastfetch** | 2.67.1 | A maintained, feature-rich and performance oriented, neofetch like system information tool | https://github.com/fastfetch-cli/fastfetch |
...
| **faust** | 2.85.9 | A functional programming language for signal processing and sound synthesis | https://github.com/grame-cncm/faust |
| **faust-static** | 2.85.9 | Static libraries for faust | https://github.com/grame-cncm/faust |
| **faustlibraries** | 2.85.9 | Faust DSP libraries | https://github.com/grame-cncm/faust |
...
| **ffmpeg** | 8.1.2-4 | Tools and libraries to manipulate a wide range of multimedia formats and protocols | https://ffmpeg.org |
...
| **flyctl** | 0.4.83 | Command line tools for fly.io services | https://fly.io |
...
| **forgejo** | 16.0.2 | Forgejo is a self-hosted lightweight software forge. | https://forgejo.org/ |
...
| **freecell-solver** | 6.16.0-2 | Freecell Solver is an open source library for automatically solving several variants of Solitaire/Patience card games, including Freecell. | https://fc-solve.shlomifish.org/ |
...
| **fresh-editor** | 0.4.9 | Text editor for your terminal: easy, powerful and fast | https://getfresh.dev/ |
...
| **garage** | 2.3.0-1 | S3-compatible object store for small self-hosted geo-distributed deployments | https://garagehq.deuxfleurs.fr/ |
...
| **geth** | 1.17.5 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.17.5 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **gflags** | 2.3.1 | A C++ library that implements commandline flags processing | https://github.com/gflags/gflags |
| **gflags-static** | 2.3.1 | Static libraries for gflags | https://github.com/gflags/gflags |
| **gforth** | 0.7.3-3 | The Forth implementation of the GNU project | https://www.gnu.org/software/gforth/ |
| **gh** | 2.97.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **git-gitk** | 2.55.0 | Git repository browser | https://git-scm.com/ |
| **git-gui** | 2.55.0 | A graphical interface to Git | https://git-scm.com/ |
...
| **gitoxide** | 0.56.0 | Rust implementation of Git | https://github.com/GitoxideLabs/gitoxide |
...
| **glab-cli** | 1.113.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
| **gleam** | 1.18.1 | A friendly language for building type-safe, scalable systems! | https://gleam.run |
| **glib** | 2.88.3 | Library providing core building blocks for libraries and applications written in C | https://developer.gnome.org/glib/ |
| **glib-cross** | 2.88.3 | glib for host (NOT for Termux) | https://developer.gnome.org/glib/ |
...
| **global** | 6.7 | Source code search and browse tools | https://www.gnu.org/software/global/ |
| **glow** | 3.0.0 | Render markdown on the CLI, with pizzazz! | https://github.com/charmbracelet/glow |
...
| **glslang** | 16.5.0 | OpenGL and OpenGL ES shader front end and validator | https://github.com/KhronosGroup/glslang |
...
| **gnunet** | 0.28.0-1 | A framework for secure peer-to-peer networking | https://gnunet.org |
...
| **gomuks** | 26.07-1 | A terminal Matrix client written in Go | https://go.mau.fi/gomuks |
...
| **gotify** | 3.0.0 | A simple server for sending and receiving messages in real-time per WebSocket. | https://github.com/gotify/server |
...
| **gpgme** | 2.1.2 | Library designed to make access to GnuPG easier | https://www.gnupg.org/related_software/gpgme/ |
| **gpgme-static** | 2.1.2 | Static libraries for gpgme | https://www.gnupg.org/related_software/gpgme/ |
| **gpgmepp** | 2.1.0 | C++ bindings for GPGME | https://www.gnupg.org/related_software/gpgme/ |
...
| **graphicsmagick** | 1.3.48 | Collection of image processing tools | http://www.graphicsmagick.org/ |
| **graphicsmagick-static** | 1.3.48 | Static libraries for graphicsmagick | http://www.graphicsmagick.org/ |
| **graphviz** | 16.0.0 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 16.0.0 | Static libraries for graphviz | https://www.graphviz.org/ |
...
| **gst-plugins-bad** | 1.28.6 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-base** | 1.28.6 | GStreamer base plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-good** | 1.28.6 | GStreamer Good Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-ugly** | 1.28.6 | GStreamer Ugly Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-python** | 1.28.6 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
| **gstreamer** | 1.28.6 | Open source multimedia framework | https://gstreamer.freedesktop.org/ |
...
| **helm** | 4.2.4 | Helm helps you manage Kubernetes applications | https://helm.sh |
...
| **html-xml-utils** | 8.8 | A number of simple utilities for manipulating HTML and XML files | https://www.w3.org/Tools/HTML-XML-utils/ |
| **html2text** | 1:2.4.0 | Utility that converts HTML documents into plain text | http://www.mbayer.de/html2text/ |
| **htop** | 3.5.2 | Interactive process viewer for Linux | https://htop.dev/ |
...
| **httrack** | 3.49.15 | It allows you to download a World Wide Web site from the Internet | http://www.httrack.com |
| **httrack-data** | 3.49.15 | Platform-independent data for httrack | http://www.httrack.com |
| **httrack-static** | 3.49.15 | Static libraries for httrack | http://www.httrack.com |
| **hub** | 2.14.2-6 | Command-line wrapper for git that makes you better at GitHub | https://hub.github.com/ |
| **hugo** | 0.165.0 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **hut** | 0.8.0-1 | A CLI tool for sr.ht | https://git.sr.ht/~xenrox/hut |
| **hwdata** | 0.410 | Database of hardware identification and configuration data | https://github.com/vcrhonek/hwdata |
...
| **hz** | 0.10.6 | A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices | https://www.cloudwego.io |
...
| **imagemagick** | 7.1.2.29 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.2.29 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **jackett** | 0.24.2360 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jbig2dec** | 0.20-2 | Decoder implementation of the JBIG2 image compression format | https://jbig2dec.com/ |
| **jbig2dec-static** | 0.20-2 | Static libraries for jbig2dec | https://jbig2dec.com/ |
| **jbig2enc** | 1:0.32 | An encoder for JBIG2 | https://github.com/agl/jbig2enc |
...
| **k2pdfopt** | 2.55-6 | A tool that optimizes PDF files for viewing on mobile readers | https://www.willus.com/k2pdfopt/ |
...
| **kakoune-lsp** | 21.0.2 | Language Server Protocol Client for the Kakoune editor | https://github.com/kakoune-lsp/kakoune-lsp |
...
| **kubectl** | 1.36.3 | Kubernetes.io client binary | https://kubernetes.io/ |
| **kubelogin** | 1.36.3 | A kubectl plugin for Kubernetes OpenID Connect (OIDC) authentication | https://github.com/int128/kubelogin |
| **kubo** | 0.43.0 | A peer-to-peer hypermedia distribution protocol | https://ipfs.io/ |
...
| **lazygit** | 0.64.1 | Simple terminal UI for git commands | https://github.com/jesseduffield/lazygit |
...
| **lego** | 5.3.1 | Let's Encrypt/ACME client and library written in Go | https://github.com/go-acme/lego |
...
| **lf** | 42 | Terminal file manager | https://github.com/gokcehan/lf |
| **lfortran** | 0.64.0 | A modern open-source interactive Fortran compiler | https://lfortran.org/ |
| **lfortran-static** | 0.64.0 | Static libraries for lfortran | https://lfortran.org/ |
...
| **lgogdownloader** | 3.18-4 | Open source downloader to GOG.com for Linux users using the same API as the official GOGDownloader | https://sites.google.com/site/gogdownloader/ |
| **lhasa** | 0.6.0 | LHA compressor/decompressor | https://lhasa.soulsphere.org/ |
...
| **libasio** | 1.36.0-1 | Cross-platform C++ library for network and low-level I/O programming | https://think-async.com/Asio |
...
| **libass** | 0.17.5 | A portable library for SSA/ASS subtitles rendering | https://github.com/libass/libass |
| **libass-static** | 0.17.5 | Static libraries for libass | https://github.com/libass/libass |
...
| **libbcprov-java** | 1.85v2 | A lightweight cryptography API for Java | https://www.bouncycastle.org/java.html |
...
| **libbsd** | 0.11.7-3 | utility functions from BSD systems | https://libbsd.freedesktop.org |
| **libbsd-static** | 0.11.7-3 | Static libraries for libbsd | https://libbsd.freedesktop.org |
...
| **libcec** | 8.1.6 | Provides support for Pulse-Eight's USB-CEC adapter and other CEC capable hardware | https://libcec.pulse-eight.com/ |
| **libcec-static** | 8.1.6 | Static libraries for libcec | https://libcec.pulse-eight.com/ |
...
| **libcoinor-cgl-static** | 0.60.10 | Static libraries for libcoinor-cgl | https://github.com/coin-or/Cgl |
| **libcoinor-osi** | 1:0.108.12 | An abstract base class to a generic linear programming (LP) solver | https://github.com/coin-or/Osi |
...
| **libcpufeatures** | 0.11.0 | A cross-platform C library to retrieve CPU features (such as available instructions) at runtime | https://github.com/google/cpu_features |
...
| **libcurl** | 8.21.0 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.21.0 | Static libraries for libcurl | https://curl.se/ |
...
| **libde265** | 1.1.1 | H.265/HEVC video stream decoder library | https://github.com/strukturag/libde265 |
...
| **libdisplay-info** | 0.4.0 | EDID and DisplayID library | https://emersion.pages.freedesktop.org/libdisplay-info/ |
...
| **libdrm** | 2.4.134 | Userspace interface to kernel DRM services | https://dri.freedesktop.org/wiki/ |
| **libduckdb** | 1.5.5 | An in-process SQL OLAP database management system | https://duckdb.org/ |
| **libduckdb-static** | 1.5.5 | Static libraries for libduckdb | https://duckdb.org/ |
...
| **libdvdread** | 7.1.1 | A library that allows easy use of sophisticated DVD navigation features | https://code.videolan.org/videolan/libdvdread |
| **libdvdread-static** | 7.1.1 | Static libraries for libdvdread | https://code.videolan.org/videolan/libdvdread |
...
| **libebml** | 1.4.7 | Extensible Binary Meta Language library | https://github.com/Matroska-Org/libebml |
| **libebur128** | 1.2.6-4 | Implements the EBU R 128 standard for loudness normalisation | https://github.com/jiixyj/libebur128 |
| **libedit** | 20260512-3.1-0 | Library providing line editing, history, and tokenization functions | https://thrysoee.dk/editline/ |
| **libedit-static** | 20260512-3.1-0 | Static libraries for libedit | https://thrysoee.dk/editline/ |
...
| **libetonyek-static** | 0.1.13-1 | Static libraries for libetonyek | https://wiki.documentfoundation.org/DLP/Libraries/libetonyek |
...
| **libffi** | 3.5.2 | Library providing a portable, high level programming interface to various calling conventions | https://sourceware.org/libffi/ |
| **libffi-static** | 3.5.2 | Static libraries for libffi | https://sourceware.org/libffi/ |
...
| **libgcrypt** | 1.12.2 | General purpose cryptographic library based on the code from GnuPG | https://www.gnu.org/software/libgcrypt/ |
| **libgcrypt-static** | 1.12.2 | Static libraries for libgcrypt | https://www.gnu.org/software/libgcrypt/ |
...
| **libgpg-error** | 1.61 | Small library that defines common error values for all GnuPG components | https://www.gnupg.org/related_software/libgpg-error/ |
| **libgpg-error-static** | 1.61 | Static libraries for libgpg-error | https://www.gnupg.org/related_software/libgpg-error/ |
| **libgraphite** | 1.3.15 | Font system for multiple languages | https://github.com/silnrsi/graphite |
| **libgrpc** | 1.83.0 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
| **libgsasl** | 2.2.4 | GNU SASL library | https://www.gnu.org/software/gsasl |
| **libgsasl-static** | 2.2.4 | Static libraries for libgsasl | https://www.gnu.org/software/gsasl |
...
| **libheif** | 1.23.1-1 | HEIF (HEIC/AVIF) image encoding and decoding library | https://github.com/strukturag/libheif |
| **libheif-progs** | 1.23.1-1 | Programs for manipulating HEIF (HEIC/AVIF) image files | https://github.com/strukturag/libheif |
...
| **libical** | 4.0.4 | Libical is an Open Source implementation of the iCalendar protocols and protocol data units | https://libical.github.io/libical/ |
...
| **libjansson** | 2.15.1 | C library for encoding, decoding and manipulating JSON data | http://www.digip.org/jansson/ |
| **libjansson-static** | 2.15.1 | Static libraries for libjansson | http://www.digip.org/jansson/ |
| **libjasper** | 4.2.9-1 | Library for manipulating JPEG-2000 files | http://www.ece.uvic.ca/~frodo/jasper/ |
| **libjasper-utils** | 4.2.9-1 | JPEG-2000 utilities | http://www.ece.uvic.ca/~frodo/jasper/ |
...
| **libliquid-dsp** | 1.7.0-2 | Software-defined radio digital signal processing library | https://liquidsdr.org/ |
| **libliquid-dsp-static** | 1.7.0-2 | Static libraries for libliquid-dsp | https://liquidsdr.org/ |
| **libllvm** | 21.1.8-3 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 21.1.8-3 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **liblo** | 0.36 | A lightweight library that provides an easy to use implementation of the OSC protocol | https://liblo.sourceforge.net/ |
| **liblo-static** | 0.36 | Static libraries for liblo | https://liblo.sourceforge.net/ |
...
| **liblog4cxx** | 1.8.0 | A logging framework for C++ patterned after Apache log4j | https://logging.apache.org/log4cxx/latest_stable/index.html |
...
| **libltdl** | 2.6.2 | Library for dlopening libraries | https://www.gnu.org/software/libtool/ |
...
| **libmicrohttpd** | 1.0.10 | A small C library that is supposed to make it easy to run an HTTP server as part of another application | http://www.gnu.org/software/libmicrohttpd/ |
| **libmicrohttpd-static** | 1.0.10 | Static libraries for libmicrohttpd | http://www.gnu.org/software/libmicrohttpd/ |
...
| **libmpc-static** | 1.4.1 | Static libraries for libmpc | https://www.multiprecision.org/ |
| **libmpdclient** | 2.27 | Asynchronous API library for interfacing MPD in the C, C++ & Objective C languages | https://www.musicpd.org/libs/libmpdclient/ |
...
| **libnfs** | 7.0.0 | NFS client library | https://github.com/sahlberg/libnfs |
...
| **libnghttp2-static** | 1.70.0 | Static libraries for libnghttp2 | https://nghttp2.org/ |
| **libnghttp3** | 1.18.0 | HTTP/3 library written in C | https://nghttp2.org/nghttp3/ |
| **libnghttp3-static** | 1.18.0 | Static libraries for libnghttp3 | https://nghttp2.org/nghttp3/ |
| **libngtcp2** | 1.25.0 | Implementation of IETF QUIC protocol | https://github.com/ngtcp2/ngtcp2 |
| **libngtcp2-static** | 1.25.0 | Static libraries for libngtcp2 | https://github.com/ngtcp2/ngtcp2 |
...
| **libodfgen-static** | 0.1.8-5 | Static libraries for libodfgen | https://sourceforge.net/p/libwpd/wiki/libodfgen/ |
...
| **libopenmpt** | 0.8.7 | Library to render tracker music formats to a PCM audio stream | https://lib.openmpt.org/libopenmpt/ |
| **libopenmpt-static** | 0.8.7 | Static libraries for libopenmpt | https://lib.openmpt.org/libopenmpt/ |
...
| **libp11** | 0.4.20 | PKCS#11 wrapper library | https://github.com/OpenSC/libp11 |
...
| **libpcsclite** | 2.5.1 | Middleware to access a smart card using SCard API (PC/SC). | https://pcsclite.apdu.fr/ |
...
| **libpluto** | 0.13.1 | Shared library for the Pluto interpreter | https://plutolang.github.io/ |
| **libpluto-static** | 0.13.1 | Static libraries for libpluto | https://plutolang.github.io/ |
...
| **libpsl** | 0.23.3 | Public Suffix List library | https://github.com/rockdaboot/libpsl |
| **libpsl-static** | 0.23.3 | Static libraries for libpsl | https://github.com/rockdaboot/libpsl |
...
| **librevenge** | 0.0.5-4 | library for REVerses ENGineered formats filters | https://sf.net/p/libwpd/librevenge/ |
| **librevenge-static** | 0.0.5-4 | Static libraries for librevenge | https://sf.net/p/libwpd/librevenge/ |
| **librime** | 1.17.0-1 | A modular, extensible input method engine in cross-platform C++ code | https://rime.im/ |
...
| **librusty-v8** | 1:2.9.4 | High quality Rust bindings to V8's C++ API | https://deno.land/ |
...
| **libsearpc** | 1:3.2.0-9 | A simple C language RPC framework (mainly for seafile) | https://github.com/haiwen/libsearpc |
| **libsearpc-static** | 1:3.2.0-9 | Static libraries for libsearpc | https://github.com/haiwen/libsearpc |
...
| **libsecp256k1** | 1:0.8.0 | Optimized c library for ECDSA signatures and seret/public key operations on curve secp256k1 | https://github.com/bitcoin-core/secp256k1 |
| **libsecp256k1-static** | 1:0.8.0 | Static libraries for libsecp256k1 | https://github.com/bitcoin-core/secp256k1 |
...
| **libtiff** | 4.7.2 | Support for the Tag Image File Format (TIFF) for storing image data | http://www.simplesystems.org/libtiff/ |
...
| **libunibreak** | 7.0 | Unicode line-breaking library | https://github.com/adah1972/libunibreak |
| **libunibreak-static** | 7.0 | Static libraries for libunibreak | https://github.com/adah1972/libunibreak |
| **libunistring** | 1.4.2 | Library providing functions for manipulating Unicode strings | https://www.gnu.org/software/libunistring/ |
| **libunistring-static** | 1.4.2 | Static libraries for libunistring | https://www.gnu.org/software/libunistring/ |
...
| **libuuid** | 2.42.1-4 | Library for handling universally unique identifiers | https://en.wikipedia.org/wiki/Util-linux |
...
| **libwayland** | 1.25.0-1 | Wayland protocol library | https://wayland.freedesktop.org/ |
| **libwayland-cross-scanner** | 1.25.0-1 | wayland-scanner for host (NOT for Termux) | https://wayland.freedesktop.org/ |
...
| **libx11** | 1.8.13-1 | X11 client-side library | https://xorg.freedesktop.org/ |
| **libx11-static** | 1.8.13-1 | Static libraries for libx11 | https://xorg.freedesktop.org/ |
...
| **libx265** | 4.3 | H.265/HEVC video stream encoder library | https://www.x265.org/ |
| **libx265-static** | 4.3 | Static libraries for libx265 | https://www.x265.org/ |
| **libxapian** | 2.1.0 | Xapian search engine library | https://xapian.org |
| **libxapian-static** | 2.1.0 | Static libraries for libxapian | https://xapian.org |
...
| **libxisf** | 0.2.13 | Library to load and save XISF images | https://nouspiro.space |
...
| **libxml2** | 2.15.3-2 | Library for parsing XML documents | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
| **libxml2-python** | 2.15.3-2 | Python bindings for libxml2 | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
| **libxml2-utils** | 2.15.3-2 | XML utilities | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
...
| **libxmp** | 4.7.2 | Extended Module Player C Library that renders tracker and module music (MOD, S3M, IT, XM etc.) | https://github.com/libxmp/libxmp |
| **libxmp-static** | 4.7.2 | Static libraries for libxmp | https://github.com/libxmp/libxmp |
...
| **libzim** | 9.8.2 | The ZIM library is the reference implementation for the ZIM file format. | https://openzim.org |
...
| **libzxing-cpp** | 3.1.1 | An open-source, multi-format 1D/2D barcode image processing library implemented in C++ | https://github.com/zxing-cpp/zxing-cpp |
| **lighttpd** | 1.4.85 | Fast webserver with minimal memory footprint | https://www.lighttpd.net |
...
| **llama-cpp** | 0.0.0-b10290-0 | LLM inference in C/C++ | https://github.com/ggml-org/llama.cpp |
| **llama-cpp-backend-opencl** | 0.0.0-b10290-0 | OpenCL Backend for LLaMA.cpp | https://github.com/ggml-org/llama.cpp |
| **llama-cpp-backend-vulkan** | 0.0.0-b10290-0 | Vulkan Backend for LLaMA.cpp | https://github.com/ggml-org/llama.cpp |
...
| **lua-language-server** | 3.19.1 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **lua51** | 5.1.5-10 | Lua scripting language 5.1.x | https://www.lua.org |
| **lua51-lpeg** | 1.1.0-6 | Pattern-matching library for Lua 5.1 | https://www.inf.puc-rio.br/~roberto/lpeg |
| **lua51-static** | 5.1.5-10 | Static libraries for lua51 | https://www.lua.org |
| **lua52** | 5.2.4-19 | Lua scripting language 5.2.x | https://www.lua.org |
| **lua52-lpeg** | 1.1.0-6 | Pattern-matching library for Lua 5.2 | https://www.inf.puc-rio.br/~roberto/lpeg |
| **lua52-static** | 5.2.4-19 | Static libraries for lua52 | https://www.lua.org |
...
| **lux-cli** | 0.41.1 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **mautrix-whatsapp** | 26.07 | A Matrix-WhatsApp puppeting bridge | https://maunium.net/go/mautrix-whatsapp/ |
...
| **mdbook** | 0.5.4 | Creates book from markdown files | https://rust-lang.github.io/mdBook/ |
...
| **mdbook-epub** | 0.5.4 | An EPUB renderer for mdbook | https://github.com/Michael-F-Bryan/mdbook-epub |
| **mdbook-graphviz** | 0.3.1 | mdbook preprocessor to add graphviz support | https://github.com/dylanowen/mdbook-graphviz |
| **mdbook-katex** | 0.10.0 | A preprocessor for mdBook, pre-rendering LaTex equations to HTML at build time | https://github.com/lzanini/mdbook-katex |
...
| **mdbook-mermaid** | 0.17.1 | A preprocessor for mdbook to add mermaid support | https://github.com/badboy/mdbook-mermaid |
...
| **mediamtx** | 1.20.0 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **mesa** | 26.0.6-2 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 26.0.6-2 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-opencl-icd-rusticl** | 26.0.6-2 | Mesa's Rusticl OpenCL ICD | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 26.0.6-2 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
| **mfcuk** | 2018.07.14-1 | MiFare Classic Universal toolKit (MFCUK) | https://github.com/nfc-tools/mfcuk |
| **mg** | 20260719 | microscopic GNU Emacs-style editor | https://github.com/hboetes/mg |
...
| **miller** | 6.21.0 | Like awk, sed, cut, join, and sort for name-indexed data such as CSV, TSV, and tabular JSON | https://miller.readthedocs.io/ |
...
| **mise** | 2026.8.5 | dev tools, env vars, task runner | https://mise.jdx.dev/ |
...
| **mold** | 2.42.0 | mold: A Modern Linker | https://github.com/rui314/mold |
...
| **moor** | 2.16.3 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **mosh** | 1.4.0-17 | Mobile shell that supports roaming and intelligent local echo | https://mosh.org |
| **mosh-perl** | 1.4.0-17 | The mosh Perl script | https://mosh.org |
| **mosquitto** | 2.1.2-2 | MQTT version 3.1/3.1.1 compatible message broker and clients | https://mosquitto.org/ |
| **most** | 5.2.0-4 | A terminal pager similar to 'more' and 'less' | http://www.jedsoft.org/most/index.html |
| **mount-utils** | 2.42.1-4 | Utilities for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **mpd** | 0.24.14 | Music player daemon | https://www.musicpd.org |
| **mpdscribble** | 0.26-1 | A Music Player Daemon (MPD) client which submits information about tracks being played to a scrobbler | https://www.musicpd.org/clients/mpdscribble/ |
| **mpg123** | 1.33.5 | Fast console MPEG Audio Player based on libmpg123 | https://mpg123.org/ |
| **mplayer** | 1.5-15 | The Movie Player | https://mplayerhq.hu/ |
...
| **mu** | 1.14.3 | Maildir indexer/searcher and Emacs client (mu4e) | https://www.djcbsoftware.nl/code/mu/ |
...
| **nala** | 0.16.0-3 | Commandline frontend for the apt package manager | https://gitlab.com/volian/nala |
| **nali** | 0.8.1-1 | An offline tool for querying IP geographic information and CDN provider | https://github.com/zu1k/nali |
| **nano** | 9.2-1 | Small, free and friendly text editor | https://www.nano-editor.org/ |
...
| **neovim-nightly** | 0.13.0~dev-1321+gb169d9376c-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **netcat-openbsd** | 1.238-1-1 | TCP/IP swiss army knife. OpenBSD variant. | https://packages.debian.org/sid/netcat-openbsd |
| **netcdf-c** | 4.10.1 | NetCDF is a set of software libraries and self-describing, machine-independent data formats that support the creation, access, and sharing of array-oriented scientific data | https://www.unidata.ucar.edu/software/netcdf/ |
| **netcdf-c-static** | 4.10.1 | Static libraries for netcdf-c | https://www.unidata.ucar.edu/software/netcdf/ |
...
| **nlopt** | 2.11.0 | Library for nonlinear optimization | https://nlopt.readthedocs.io/ |
| **nmap** | 7.991 | Utility for network discovery and security auditing | https://nmap.org/ |
...
| **nnn** | 5.3 | Free, fast, friendly file browser | https://github.com/jarun/nnn |
...
| **nodejs** | 26.4.0-1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
| **nodejs-lts** | 24.18.0-1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
...
| **nushell** | 0.114.1-1 | A new type of shell operating on structured data | https://www.nushell.sh |
| **nyancat** | 1.5.2-1 | Nyancat in your terminal, rendered through ANSI escape sequences. | http://nyancat.dakko.us |
| **nzbget** | 26.0-1 | The most efficient usenet downloader | https://nzbget.com/ |
...
| **oma** | 1.26.6 | oma is an attempt at reworking APT's interface | https://aosc.io/oma |
...
| **onnxruntime** | 1.29.0 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **openfoam** | 2606 | OpenFOAM is a CFD software written in C++ | https://www.openfoam.com |
...
| **openjdk-17** | 17.0.20 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-17-source** | 17.0.20 | Source files for openjdk-17 | https://openjdk.java.net |
| **openjdk-17-x** | 17.0.20 | Portion of openjdk-17 requiring X11 functionality | https://openjdk.java.net |
| **openjdk-21** | 21.0.12 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-21-source** | 21.0.12 | Source files for openjdk-21 | https://openjdk.java.net |
| **openjdk-21-x** | 21.0.12 | Portion of openjdk-21 requiring X11 functionality | https://openjdk.java.net |
| **openjdk-25** | 25.0.4 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-25-source** | 25.0.4 | Source files for openjdk-25 | https://openjdk.java.net |
| **openjdk-25-x** | 25.0.4 | Portion of openjdk-25 requiring X11 functionality | https://openjdk.java.net |
...
| **openldap** | 2.7.0 | OpenLDAP server | https://openldap.org |
| **openldap-static** | 2.7.0 | Static libraries for openldap | https://openldap.org |
...
| **openscad** | 2021.01-7 | The programmers solid 3D CAD modeller (headless build) | https://openscad.org/ |
| **openssh** | 10.5p1 | Secure shell for logging into a remote machine | https://www.openssh.com/ |
| **openssh-sftp-server** | 10.5p1 | OpenSSH SFTP server subsystem | https://www.openssh.com/ |
...
| **openxr** | 1.1.62 | Open standard that provides a common set of APIs for developing XR applications | https://www.khronos.org/openxr/ |
| **opkssh** | 0.16.0 | Enables SSH to be used with OpenID Connect | https://github.com/openpubkey/opkssh |
...
| **orbiton** | 2.74.4-1 | Small, fast and limited text editor | https://roboticoverlords.org/orbiton/ |
| **osm2pgsql** | 2.3.1-1 | osm2pgsql imports OpenStreetMap (OSM) data into a PostgreSQL/PostGIS database | https://osm2pgsql.org/ |
| **osmctools** | 0.9-4 | Simple tools for OpenStreetMap processing | https://gitlab.com/osm-c-tools/osmctools |
...
| **par2** | 1.3.0 | par2cmdline is a PAR 2.0 compatible file verification and repair tool | https://github.com/Parchive/par2cmdline |
| **parallel** | 20260622 | GNU Parallel is a shell tool for executing jobs in parallel using one or more machines | https://www.gnu.org/software/parallel/ |
...
| **pcscd** | 2.5.1 | Middleware to access a smart card using SCard API (PC/SC). (daemon side) | https://pcsclite.apdu.fr/ |
| **pdf2svg** | 0.2.4-2 | A PDF to SVG converter | http://www.cityinthesky.co.uk/opensource/pdf2svg/ |
| **pdfcpu** | 0.15.0 | A PDF processor written in Go | https://pdfcpu.io |
...
| **picolisp** | 26.6-1 | Lisp interpreter and application server framework | https://picolisp.com/wiki/?home |
...
| **pinentry** | 1.3.3 | Dialog allowing secure password entry | https://www.gnupg.org/related_software/pinentry/index.html |
...
| **pkgfile** | 26 | An alpm .files metadata explorer | https://github.com/falconindy/pkgfile |
...
| **plutolang** | 0.13.1 | A superset of Lua 5.4 with a focus on general-purpose programming. | https://plutolang.github.io/ |
...
| **pocketbase** | 0.39.11 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **poppler** | 26.02.0-1 | PDF rendering library | https://poppler.freedesktop.org/ |
...
| **pygobject** | 3.56.3-1 | Python package which provides bindings for GObject based libraries | https://pygobject.gnome.org/ |
...
| **python-ctranslate2** | 4.8.1-1 | Python bindings for CTranslate2 | https://github.com/OpenNMT/CTranslate2 |
...
| **python-lxml** | 6.1.1-1 | Python binding for the libxml2 and libxslt libraries | https://github.com/lxml/lxml |
| **python-manimpango** | 0.6.1 | Binding for Pango, to use with Manim. | https://github.com/ManimCommunity/ManimPango |
| **python-msgpack** | 1.2.1-2 | MessagePack serializer implementation for Python | https://github.com/msgpack/msgpack-python |
...
| **python-onnxruntime** | 1.29.0 | Cross-platform, high performance ML inferencing and training accelerator (Python bindings) | https://onnxruntime.ai/ |
...
| **python-pymupdf** | 1.28.0-1 | Python bindings for MuPDF's rendering library | https://github.com/pymupdf/PyMuPDF |
...
| **python-ruff** | 0.16.3 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **python-soxr** | 1.1.0 | Fast and high quality sample-rate conversion library for Python | https://github.com/dofuuz/python-soxr |
| **python-static** | 3.14.6-1 | Static libraries for python | https://python.org/ |
| **python-tflite-runtime** | 2.20.0-4 | TensorFlow Lite Python bindings | https://www.tensorflow.org/lite |
...
| **python-torch** | 2.11.0-2 | Tensors and Dynamic neural networks in Python | https://pytorch.org/ |
...
| **python-yt-dlp** | 2026.07.04 | A youtube-dl fork with additional features and fixes | https://github.com/yt-dlp/yt-dlp |
...
| **qemu-system-i386-headless** | 1:11.0.3 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-m68k-headless** | 1:11.0.3 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc-headless** | 1:11.0.3 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc64-headless** | 1:11.0.3 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv32-headless** | 1:11.0.3 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv64-headless** | 1:11.0.3 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless** | 1:11.0.3 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-user-aarch64** | 1:11.0.3 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-arm** | 1:11.0.3 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-i386** | 1:11.0.3 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-m68k** | 1:11.0.3 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc** | 1:11.0.3 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc64** | 1:11.0.3 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv32** | 1:11.0.3 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv64** | 1:11.0.3 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-x86-64** | 1:11.0.3 | QEMU Linux user mode emulator | https://www.qemu.org |
...
| **qpdf** | 12.4.0 | Content-Preserving PDF Transformation System | http://qpdf.sourceforge.net |
...
| **ravencoin** | 4.6.1-10 | A peer-to-peer blockchain, handling the efficient creation and transfer of assets from one party to another | https://ravencoin.org/ |
...
| **rdiff-backup** | 2.2.6-6 | A utility for local/remote mirroring and incremental backups | https://rdiff-backup.net |
...
| **recoll** | 1.44.1-1 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.44.1-1 | Python interface for Recoll | https://www.recoll.org/ |
...
| **redis** | 1:8.8.1-1 | In-memory data structure store used as a database, cache and message broker | https://redis.io/ |
| **redland** | 1.0.17-1 | Library that provides a high-level interface to RDF data | http://librdf.org/ |
| **remind** | 1:06.02.10 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **rgbds** | 1.0.3 | Rednex Game Boy Development System - An assembly toolchain for the Nintendo Game Boy & Game Boy Color | https://rgbds.gbdev.io |
...
| **rizin** | 0.9.1-1 | UNIX-like reverse engineering framework and command-line toolset. | https://rizin.re |
...
| **ruff** | 0.16.3 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust-std-aarch64-linux-android** | 1.97.1 | Component files for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.97.1 | Component files for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.97.1 | Component files for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.97.1 | Component files for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip1** | 1.97.1 | Component files for target wasm32-wasip1 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip2** | 1.97.1 | Component files for target wasm32-wasip2 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip3** | 1.97.1 | Component files for target wasm32-wasip3 | https://www.rust-lang.org/ |
| **rust-std-wasm32v1-none** | 1.97.1 | Component files for target wasm32v1-none | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.97.1 | Component files for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.97.1 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.97.1 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **sabnzbd** | 5.1.0 | Fully automated Usenet Binary Downloader | https://sabnzbd.org/ |
...
| **sbcl** | 2.6.7 | A high performance Common Lisp compiler | http://www.sbcl.org/ |
...
| **seafile-client** | 9.0.21 | Seafile is a file syncing and sharing software with file encryption and group sharing | https://seafile.com |
| **seafile-client-static** | 9.0.21 | Static libraries for seafile-client | https://seafile.com |
...
| **seerr** | 3.4.1 | A fork of Overseerr with focus on adding support for Jellyfin/Emby | https://github.com/seerr-team/seerr |
...
| **serd** | 0.32.10 | A lightweight C library for RDF syntax | https://drobilla.net/software/serd.html |
...
| **shaderc** | 2026.3 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **snapcast-client** | 0.35.0-1 | A multiroom client-server audio player (client) | https://github.com/snapcast/snapcast |
| **snapcast-server** | 0.35.0-1 | A multiroom client-server audio player (server) | https://github.com/snapcast/snapcast |
| **snmptt** | 1.5 | SNMP trap translator | http://www.snmptt.org/ |
| **snowflake** | 2.14.1 | Pluggable Transport using WebRTC, inspired by Flashproxy | https://snowflake.torproject.org/ |
| **snowflake-client** | 2.14.1 | Pluggable Transport using WebRTC, inspired by Flashproxy (Client) | https://snowflake.torproject.org/ |
| **snowflake-proxy** | 2.14.1 | Pluggable Transport using WebRTC, inspired by Flashproxy (Proxy) | https://snowflake.torproject.org/ |
| **socat** | 1.8.1.3 | Relay for bidirectional data transfer between two independent data channels | http://www.dest-unreach.org/socat/ |
...
| **sonarr** | 4.0.19.2979-3 | A PVR for Usenet and BitTorrent users (server) | https://sonarr.tv |
...
| **speedtest-go** | 1.7.11 | Command line interface to test internet speed using speedtest.net | https://github.com/showwin/speedtest-go/ |
...
| **stduuid** | 1.2.3-1 | C++17 cross-platform single-header library implementation for universally unique identifiers | https://github.com/mariusbancila/stduuid |
...
| **suitesparse** | 2:7.13.0 | A Suite of Sparse matrix packages. | https://github.com/DrTimothyAldenDavis/SuiteSparse |
| **suitesparse-static** | 2:7.13.0 | Static libraries for suitesparse | https://github.com/DrTimothyAldenDavis/SuiteSparse |
| **sun** | 1.0.0-3 | A very simple note taking cli app | https://stand-up-notes.org |
| **sundials** | 2:7.8.0 | SUite of Nonlinear and DIfferential/ALgebraic equation Solvers. | https://computing.llnl.gov/projects/sundials |
| **sundials-static** | 2:7.8.0 | Static libraries for sundials | https://computing.llnl.gov/projects/sundials |
| **supercollider** | 3.14.1-1 | A platform for audio synthesis and algorithmic composition | http://supercollider.github.io/ |
...
| **swi-prolog** | 10.1.13 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **taglib** | 2.3.1 | A Library for reading and editing the meta-data of several popular audio formats. | http://taglib.github.io/ |
...
| **termux-apt-repo** | 0.5-5 | Script to create Termux apt repositories | https://github.com/termux/termux-apt-repo |
...
| **termux-exec** | 1:2.5.0-1 | Utils and libraries for Termux exec including a LD_PRELOAD shared library for proper functioning of the Termux execution environment | https://github.com/termux/termux-exec-package |
| **termux-exec-static** | 1:2.5.0-1 | Static libraries for termux-exec | https://github.com/termux/termux-exec-package |
...
| **tesseract** | 5.5.3 | Tesseract is probably the most accurate open source OCR engine available | https://github.com/tesseract-ocr/tesseract |
...
| **trzsz-ssh** | 0.1.26 | An openssh client alternative | https://trzsz.github.io/ssh |
...
| **ttyd** | 1.7.7-5 | Command-line tool for sharing terminal over the web | https://tsl0922.github.io/ttyd/ |
| **ttyper** | 1.6.0-1 | Terminal-based typing test | https://github.com/max-niederman/ttyper |
| **ttyplot** | 1.7.6 | A realtime plotting utility for terminal with data input from stdin | https://github.com/tenox7/ttyplot |
...
| **turbopack** | 16.2.12 | Rust-based incremental compilation engine and bundler for Next.js | https://nextjs.org/ |
...
| **unrar** | 7.2.7 | Tool for extracting files from .rar archives | https://www.rarlab.com/ |
...
| **upower** | 1.91.3 | Power management support for DeviceKit | https://upower.freedesktop.org/ |
| **upx** | 5.2.0 | the Ultimate Packer for eXecutables | https://upx.github.io/ |
...
| **util-linux** | 2.42.1-4 | Miscellaneous system utilities | https://en.wikipedia.org/wiki/Util-linux |
...
| **uv** | 0.12.5 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
| **uwsgi** | 2.0.31-2 | uWSGI application server container | https://projects.unbit.it/uwsgi |
| **v2ray** | 5.52.0 | A platform for building proxies to bypass network restrictions | https://www.v2fly.org/ |
...
| **vis** | 0.9-p20250111-1 | Modern, legacy free, simple yet efficient vim-like editor | https://www.brain-dump.org/projects/vis/ |
...
| **vlc** | 3.0.23-5 | A popular libre and open source media player and multimedia engine | https://www.videolan.org/ |
...
| **vtm** | 2026.07.22 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **vulkan-headers** | 1.4.360 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.360 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.360 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.360 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
| **vulkan-validation-layers** | 1.4.357 | Vulkan Validation Layers | https://github.com/KhronosGroup/Vulkan-ValidationLayers |
...
| **wakatime-cli** | 2.24.4 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **wasm-component-ld** | 0.5.29 | Command line linker for creating WebAssembly components | https://github.com/bytecodealliance/wasm-component-ld |
...
| **weechat** | 4.10.0 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.10.0 | WeeChat Lua Plugin | https://weechat.org/ |
...
| **weechat-perl-plugin** | 4.10.0 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.10.0 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.10.0 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **wireproxy** | 1.1.3 | Wireguard client that exposes itself as a socks5 proxy | https://github.com/pufferffish/wireproxy |
...
| **wtfutil** | 0.50.0 | The personal information dashboard for your terminal | https://wtfutil.com/ |
| **wuzz** | 0.5.0-6 | Interactive command line tool for HTTP inspection | https://github.com/asciimoo/wuzz |
...
| **x265** | 4.3 | H.265/HEVC video stream encoder tool | https://www.x265.org/ |
| **xapian-tools** | 2.1.0 | Basic tools for the Xapian search engine | https://xapian.org |
...
| **xsimd** | 14.3.0 | C++ wrappers for SIMD intrinsics | https://github.com/xtensor-stack/xsimd |
...
| **yara** | 4.5.8-1 | Tool aimed at helping malware researchers to identify and classify malware samples | https://github.com/VirusTotal/yara |
| **yara-static** | 4.5.8-1 | Static libraries for yara | https://github.com/VirusTotal/yara |
...
| **z-push** | 2.7.6-1 | An open-source application to synchronize ActiveSync compatible devices and Outlook | https://z-push.org/ |
| **z3** | 5.0.0 | Z3 is a theorem prover from Microsoft Research | https://github.com/Z3Prover/z3 |
...
| **zile** | 2.6.4-3 | Lightweight clone of the Emacs text editor | https://www.gnu.org/software/zile/ |
...
| **zk** | 0.15.6 | A plain text note-taking assistant | https://zk-org.github.io/zk/ |
...
| **zola** | 0.23.3 | A fast static site generator in a single binary with everything built-in. | https://github.com/getzola/zola |
