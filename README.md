...
| **cloudflared** | 2026.7.1 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **oh-my-posh** | 29.30.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
