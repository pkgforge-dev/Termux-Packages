...
| **apache-orc** | 2.1.1 | Columnar storage for Hadoop workloads | https://orc.apache.org/ |
...
| **ccache** | 4.11.2 | Compiler cache for fast recompilation of C/C++ code | https://ccache.samba.org |
...
| **chezmoi** | 2.62.2 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **clang** | 20.1.3-1 | C language frontend for LLVM | https://clang.llvm.org/ |
...
| **command-not-found** | 2.4.0-73 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **edbrowse** | 3.8.11 | Line based editor, browser, and mail client | https://edbrowse.org/ |
...
| **esbuild** | 0.25.3 | An extremely fast JavaScript bundler | https://esbuild.github.io/ |
...
| **eza** | 0.21.2 | A modern replacement for ls | https://github.com/eza-community/eza |
...
| **fluidsynth** | 2.4.5 | Software synthesizer based on the SoundFont 2 specifications | https://github.com/FluidSynth/fluidsynth |
...
| **fzf** | 0.61.3 | Command-line fuzzy finder | https://junegunn.github.io/fzf/ |
...
| **glab-cli** | 1.56.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
| **gleam** | 1.10.0 | A friendly language for building type-safe, scalable systems! | https://gleam.run |
| **glib** | 2.84.1-2 | Library providing core building blocks for libraries and applications written in C | https://developer.gnome.org/glib/ |
| **glib-bin** | 2.84.1-1 | Programs for the GLib library | https://developer.gnome.org/glib/ |
| **glib-cross** | 2.84.1-2 | glib for host (NOT for Termux) | https://developer.gnome.org/glib/ |
...
| **goose** | 3.24.2 | A database migration tool. Supports SQL migrations and Go functions. | https://pressly.github.io/goose |
...
| **hugo** | 0.147.1 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **hwdata** | 0.394 | Database of hardware identification and configuration data | https://github.com/vcrhonek/hwdata |
...
| **jackett** | 0.22.1846 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jql** | 8.0.5 | A JSON Query Language CLI tool | https://github.com/yamafaktory/jql |
...
| **k9s** | 0.50.4 | Kubernetes CLI To Manage Your Clusters In Style! | https://k9scli.io |
...
| **keychain** | 2.9.1 | keychain ssh-agent front-end | https://www.funtoo.org/Keychain |
...
| **lazygit** | 0.49.0 | Simple terminal UI for git commands | https://github.com/jesseduffield/lazygit |
...
| **libcompiler-rt** | 20.1.3-1 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libftxui** | 6.1.8 | A simple C++ library for terminal based user interface | https://github.com/ArthurSonzogni/FTXUI |
...
| **libllvm** | 20.1.3-1 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 20.1.3-1 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libminizip-ng** | 4.0.9 | A zip manipulation library written in C | https://github.com/zlib-ng/minizip-ng |
...
| **libnss** | 3.110 | Network Security Services (NSS) | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **libtorrent** | 0.15.3 | Libtorrent BitTorrent library | https://github.com/rakshasa/rtorrent/wiki |
...
| **libtorrent-static** | 0.15.3 | Static libraries for libtorrent | https://github.com/rakshasa/rtorrent/wiki |
...
| **lld** | 20.1.3-1 | LLVM-based linker | https://clang.llvm.org/ |
| **llvm** | 20.1.3-1 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
...
| **llvm-tools** | 20.1.3-1 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 20.1.3-1 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **mdbook** | 0.4.48 | Creates book from markdown files | https://rust-lang.github.io/mdBook/ |
...
| **mediamtx** | 1.12.0 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **mlir** | 20.1.3-1 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
...
| **mold** | 2.38.1 | mold: A Modern Linker | https://github.com/rui314/mold |
...
| **mu** | 1.12.9 | Maildir indexer/searcher and Emacs client (mu4e) | https://www.djcbsoftware.nl/code/mu/ |
...
| **mympd** | 20.1.3 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **notcurses** | 3.0.15 | blingful TUIs and character graphics | https://notcurses.com/ |
| **notcurses-data** | 3.0.15 | Platform-independent data for notcurses | https://notcurses.com/ |
| **notcurses-tools** | 3.0.15 | Tools and demos for notcurses | https://notcurses.com/ |
...
| **nss-utils** | 3.110 | Tools for NSS | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **oh-my-posh** | 25.20.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **openjdk-21** | 21.0.7 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-21-source** | 21.0.7 | Source files for openjdk-21 | https://openjdk.java.net |
| **openjdk-21-x** | 21.0.7 | Portion of openjdk-21 requiring X11 functionality | https://openjdk.java.net |
...
| **pocketbase** | 0.27.2 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **python-apsw** | 3.49.1.0 | Another Python SQLite Wrapper | https://github.com/rogerbinns/apsw/ |
...
| **python-greenlet** | 3.2.1 | Lightweight coroutines for in-process concurrent programming | https://github.com/python-greenlet/greenlet |
...
| **python-yt-dlp** | 2025.04.30 | A youtube-dl fork with additional features and fixes | https://github.com/yt-dlp/yt-dlp |
...
| **qpdf** | 12.1.0 | Content-Preserving PDF Transformation System | http://qpdf.sourceforge.net |
| **qpdf-static** | 12.1.0 | Static libraries for qpdf | http://qpdf.sourceforge.net |
...
| **railway-cli** | 4.3.0 | This is the command line interface for Railway | https://railway.app |
...
| **rtorrent** | 0.15.2 | Ncurses BitTorrent client based on libTorrent | https://rakshasa.github.io/rtorrent/ |
...
| **ruff** | 0.11.8 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust-analyzer** | 20250428 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **sing-box** | 1.11.9 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **solidity** | 0.8.29-2 | An Ethereum smart contract-oriented language | https://solidity.readthedocs.io |
...
| **spirv-headers** | 1.4.309.0 | SPIR-V Headers | https://github.com/KhronosGroup/SPIRV-Headers |
...
| **teleport-tsh** | 17.4.7 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **tree-sitter-vim** | 0.5.0-1 | Vimscript grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-vim |
| **tree-sitter-vim-static** | 0.5.0-1 | Static libraries for tree-sitter-vim | https://github.com/tree-sitter-grammars/tree-sitter-vim |
...
| **usql** | 0.19.21 | A universal command-line interface for SQL databases | https://github.com/xo/usql |
...
| **uv** | 0.7.2-1 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **yosys** | 0.52 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
...
| **z3** | 4.14.1 | Z3 is a theorem prover from Microsoft Research | https://github.com/Z3Prover/z3 |
...
| **zrok** | 1.0.3 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
