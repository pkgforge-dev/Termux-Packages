...
| **hugo** | 0.151.1 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **lux-cli** | 0.18.4 | A package manager for Lua, similar to luarocks | https://nvim-neorocks.github.io/ |
...
| **oh-my-posh** | 27.2.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **uv** | 0.9.3 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
