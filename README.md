...
| **lua-language-server** | 3.13.7 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **oh-my-posh** | 25.3.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **pygobject** | 3.52.1 | Python package which provides bindings for GObject based libraries | https://pygobject.gnome.org/ |
