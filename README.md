...
| **broot** | 1.49.0 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **command-not-found** | 3.1-12 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **jackett** | 0.23.20 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **ndk-multilib** | 28c-2 | Multilib binaries for cross-compilation | https://developer.android.com/tools/sdk/ndk/index.html |
| **ndk-multilib-native-static** | 28c-2 | Install native static libs from NDK | https://developer.android.com/tools/sdk/ndk/index.html |
| **ndk-multilib-native-stubs** | 28c-2 | Install native stubs for shared libs from NDK | https://developer.android.com/tools/sdk/ndk/index.html |
...
| **pygobject** | 3.54.2 | Python package which provides bindings for GObject based libraries | https://pygobject.gnome.org/ |
...
| **remind** | 1:06.01.01 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **sc-im** | 0.8.5-2 | An improved version of sc, a spreadsheet calculator | https://github.com/andmarti1424/sc-im |
| **scala** | 3.7.3 | Scala 3 compiler and standard library. | https://www.scala-lang.org |
| **scc** | 3.5.0-1 | Counts physical the lines of code, blank lines, comment lines, and physical lines of source code | https://github.com/boyter/scc |
| **sccache** | 0.10.0-1 | sccache is ccache with cloud storage | https://github.com/mozilla/sccache |
...
| **sd** | 1.0.0-2 | An intuitive find & replace CLI | https://github.com/chmln/sd |
...
| **serd** | 0.32.4-1 | A lightweight C library for RDF syntax | https://drobilla.net/software/serd.html |
...
| **sftpgo** | 2.6.6-1 | Full-featured and highly configurable SFTP, HTTP/S, FTP/S and WebDAV server | https://sftpgo.com/ |
| **shaderc** | 2025.3-1 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **shfmt** | 3.12.0-1 | A shell parser and formatter | https://github.com/mvdan/sh |
| **shiori** | 1.7.4-1 | Simple bookmark manager built with Go | https://github.com/go-shiori/shiori |
...
| **soju** | 0.9.0-1 | A user-friendly IRC bouncer | https://codeberg.org/emersion/soju |
| **solidity** | 0.8.30-1 | An Ethereum smart contract-oriented language | https://solidity.readthedocs.io |
| **sops** | 3.10.2-1 | Simple and flexible tool for managing secrets | https://github.com/getsops/sops |
| **sord** | 0.16.18-1 | A lightweight C library for storing RDF data in memory | https://drobilla.net/software/sord.html |
...
| **speechd** | 0.11.5-2 | Common interface to speech synthesis | https://github.com/brailcom/speechd |
| **speechd-data** | 0.11.5-2 | Platform-independent data for speechd | https://github.com/brailcom/speechd |
...
| **spidermonkey** | 128.10.0-1 | Mozilla's JavaScript engine | https://spidermonkey.dev |
...
| **spirv-tools** | 1.4.321.0-2 | SPIR-V Tools | https://github.com/KhronosGroup/SPIRV-Tools |
...
| **squid** | 7.1-1 | Full-featured Web proxy cache server | http://www.squid-cache.org |
| **sratom** | 0.6.18-1 | A small library for serialising LV2 atoms to and from RDF | https://drobilla.net/software/sratom.html |
...
| **sslscan** | 2.2.0-1 | Utility to discover supported cipher suites on SSL/TLS enabled servers | https://github.com/rbsec/sslscan |
...
| **starship** | 1.23.0-1 | A minimal, blazing fast, and extremely customizable prompt for any shell | https://starship.rs |
...
| **stunnel** | 5.75-1 | Socket wrapper which can provide TLS support to ordinary applications | https://www.stunnel.org/ |
| **stunnel-static** | 5.75-1 | Static libraries for stunnel | https://www.stunnel.org/ |
| **stuntman** | 1.2.16-6 | An open source STUN server | https://www.stunprotocol.org/ |
| **stylua** | 2.1.0-1 | An opinionated Lua code formatter | https://github.com/JohnnyMorganz/StyLua |
...
| **suil** | 0.10.22-1 | A library for loading and wrapping LV2 plugin UIs | https://drobilla.net/software/suil.html |
...
| **swi-prolog** | 9.3.22-1 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **syncthing** | 2.0.9 | Decentralized file synchronization | https://syncthing.net/ |
...
| **texlive-bin** | 1:2025.0-1 | TeX Live is a distribution of the TeX typesetting system. This package contains architecture dependent binaries. | https://www.tug.org/texlive/ |
| **texlive-bin-static** | 1:2025.0-1 | Static libraries for texlive-bin | https://www.tug.org/texlive/ |
| **texlive-installer** | 20250308 | Wrapper around texlive's install-tl script | https://www.tug.org/texlive/ |
| **tgpt** | 2.10.0-1 | AI Chatbots in terminal without needing API keys | https://github.com/aandrew-me/tgpt |
...
| **tig** | 2.5.12-1 | Ncurses-based text-mode interface for git | https://jonas.github.io/tig/ |
...
| **timg** | 1.6.2-1 | A terminal image and video viewer | https://timg.sh/ |
...
| **tintin++** | 2.02.51-1 | Classic text-based MUD client | https://tintin.mudhalla.net |
...
| **topgrade** | 16.0.4-1 | Upgrade all the things | https://github.com/topgrade-rs/topgrade/ |
| **tor** | 0.4.8.17-1 | The Onion Router anonymizing overlay network | https://www.torproject.org |
...
| **toxic** | 0.16.1-3 | A command line client for Tox | https://github.com/JFreegman/toxic |
...
| **transmission** | 4.0.6-5 | Easy, lean and powerful BitTorrent client | https://transmissionbt.com/ |
...
| **tree-sitter-markdown** | 0.5.0-4 | Markdown grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-markdown |
...
| **tree-sitter-vimdoc** | 4.0.0-3 | Tree-sitter parser for Vim help files | https://github.com/neovim/tree-sitter-vimdoc |
| **tree-sitter-vimdoc-static** | 4.0.0-3 | Static libraries for tree-sitter-vimdoc | https://github.com/neovim/tree-sitter-vimdoc |
...
| **trzsz-ssh** | 0.1.22-1 | An openssh client alternative | https://trzsz.github.io/ssh |
...
| **ttyd** | 1.7.7-2 | Command-line tool for sharing terminal over the web | https://tsl0922.github.io/ttyd/ |
| **ttyper** | 1.6.0-1 | Terminal-based typing test | https://github.com/max-niederman/ttyper |
| **ttyplot** | 1.7.1-1 | A realtime plotting utility for terminal with data input from stdin | https://github.com/tenox7/ttyplot |
...
| **typst** | 0.13.1-1 | A new markup-based typesetting system that is powerful and easy to learn | https://typst.app/ |
...
| **unar** | 1.10.8-2 | Command line tools for archive and file unarchiving and extraction | https://theunarchiver.com/command-line |
...
| **unixodbc** | 2.3.12-1 | An Open Source ODBC sub-system and an ODBC SDK for Linux, Mac OSX, and UNIX | https://www.unixodbc.org/ |
| **unixodbc-static** | 2.3.12-1 | Static libraries for unixodbc | https://www.unixodbc.org/ |
...
| **vegeta** | 12.12.0-1 | HTTP load testing tool | https://github.com/tsenart/vegeta |
...
| **vgmstream** | 2023-2 | A library for playback of various streamed audio formats used in video games | https://github.com/vgmstream/vgmstream |
...
| **vlc** | 3.0.21-11 | A popular libre and open source media player and multimedia engine | https://www.videolan.org/ |
...
| **wabt** | 1.0.37-1 | The WebAssembly Binary Toolkit | https://github.com/WebAssembly/wabt |
...
| **waypipe** | 0.10.4-1 | A proxy for Wayland clients | https://gitlab.freedesktop.org/mstoeckl/waypipe |
...
| **websocat** | 1.14.0-2 | Command-line client for WebSockets, like netcat (or curl) for ws:// with advanced socat-like functions | https://github.com/vi/websocat |
...
| **wget2** | 2.2.0-1 | The successor of GNU Wget, a file and recursive website downloader | https://gitlab.com/gnuwget/wget2 |
| **wget2-static** | 2.2.0-1 | Static libraries for wget2 | https://gitlab.com/gnuwget/wget2 |
...
| **whois** | 5.6.3-1 | An intelligent Whois client | https://github.com/rfc1036/whois |
...
| **xh** | 0.24.1-1 | A friendly and fast tool for sending HTTP requests | https://github.com/ducaale/xh |
...
| **xmlsec** | 1.3.7-3 | XML Security Library | https://www.aleksey.com/xmlsec/ |
| **xmlsec-static** | 1.3.7-3 | Static libraries for xmlsec | https://www.aleksey.com/xmlsec/ |
...
| **yara** | 4.5.4-1 | Tool aimed at helping malware researchers to identify and classify malware samples | https://github.com/VirusTotal/yara |
| **yara-static** | 4.5.4-1 | Static libraries for yara | https://github.com/VirusTotal/yara |
...
| **yazi** | 25.5.31-2 | Blazing fast terminal file manager written in Rust, based on async I/O | https://yazi-rs.github.io/ |
...
| **znc** | 1.10.1-1 | An advanced IRC bouncer | https://znc.in/ |
| **zola** | 0.21.0-1 | A fast static site generator in a single binary with everything built-in. | https://github.com/getzola/zola |
