...
| **lux-cli** | 0.28.1 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **python-pyppmd** | 1.2.0 | PPM compression/decompression library | https://github.com/miurahr/pyppmd |
