...
| **7zip** | 26.02-1 | 7-Zip file archiver with a high compression ratio | https://www.7-zip.org |
...
| **algernon** | 1.17.10 | Small self-contained web server with Lua, Markdown, QUIC, Redis and PostgreSQL support | https://algernon.roboticoverlords.org/ |
...
| **android-tools** | 36.0.1-1 | Android platform tools | https://developer.android.com/ |
...
| **catch2** | 3.15.2 | A modern, C++-native, header-only, framework for unit-tests, TDD and BDD | https://github.com/catchorg/catch2 |
| **catch2-static** | 3.15.2 | Static libraries for catch2 | https://github.com/catchorg/catch2 |
...
| **cec-client** | 8.1.0 | Client applications for libCEC | https://libcec.pulse-eight.com/ |
...
| **cloudflared** | 2026.7.3 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **emscripten** | 6.0.3 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 6.0.3 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 6.0.3 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 6.0.3 | Emscripten third party test suite files | https://emscripten.org |
...
| **erlang-doc** | 29.0.3 | Erlang HTML documentation | https://www.erlang.org/ |
...
| **geth** | 1.17.4 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.17.4 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **gitea** | 1.27.0-1 | Git with a cup of tea, painless self-hosted git service | https://gitea.io |
...
| **glab-cli** | 1.109.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **gst-plugins-bad** | 1.28.5 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
...
| **keychain** | 3.0.0-1 | Keychain manager for ssh-agent and gpg-agent | https://kernel-seeds.org/projects/keychain/ |
...
| **libarchive** | 3.8.8 | Multi-format archive and compression library | https://www.libarchive.org/ |
| **libarchive-static** | 3.8.8 | Static libraries for libarchive | https://www.libarchive.org/ |
...
| **libcec** | 8.1.0 | Provides support for Pulse-Eight's USB-CEC adapter and other CEC capable hardware | https://libcec.pulse-eight.com/ |
| **libcec-static** | 8.1.0 | Static libraries for libcec | https://libcec.pulse-eight.com/ |
...
| **libxmlb** | 0.3.28 | Library to help create and query binary XML blobs | https://github.com/hughsie/libxmlb |
...
| **libxmp** | 4.7.1 | Extended Module Player C Library that renders tracker and module music (MOD, S3M, IT, XM etc.) | https://github.com/libxmp/libxmp |
| **libxmp-static** | 4.7.1 | Static libraries for libxmp | https://github.com/libxmp/libxmp |
...
| **luajit** | 1:2.1.1784902473+g346ab58 | Just-In-Time Compiler for Lua | https://luajit.org/ |
...
| **luajit-static** | 1:2.1.1784902473+g346ab58 | Static libraries for luajit | https://luajit.org/ |
...
| **lux-cli** | 0.39.3 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **moor** | 2.15.1-1 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **neovim-nightly** | 0.13.0~dev-1124+gd57cf6b4fc-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **oxfmt** | 1.75.0 | Oxc JavaScript formatter | https://oxc.rs/ |
| **oxlint** | 1.75.0 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **python-apsw** | 3.53.3.1 | Another Python SQLite Wrapper | https://rogerbinns.github.io/apsw/ |
...
| **railway-cli** | 5.28.1 | This is the command line interface for Railway | https://railway.app |
...
| **rust-analyzer** | 20260720 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **uv** | 0.11.32 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **weechat** | 4.9.4 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.9.4 | WeeChat Lua Plugin | https://weechat.org/ |
...
| **weechat-perl-plugin** | 4.9.4 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.9.4 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.9.4 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **xh** | 0.26.1-1 | A friendly and fast tool for sending HTTP requests | https://github.com/ducaale/xh |
