...
| **dasel** | 3.1.2 | Select, put and delete data from JSON, TOML, YAML, XML and CSV files with a single utility | https://github.com/TomWright/dasel |
...
| **oh-my-posh** | 28.3.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **simdjson** | 4.2.4 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
