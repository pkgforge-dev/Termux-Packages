...
| **awscli** | 2.33.31 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **clvk** | 0.0.20260223.234457 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
...
| **dasel** | 3.3.1 | Select, put and delete data from JSON, TOML, YAML, XML and CSV files with a single utility | https://github.com/TomWright/dasel |
...
| **emscripten** | 5.0.2 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 5.0.2 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 5.0.2 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 5.0.2 | Emscripten third party test suite files | https://emscripten.org |
...
| **fresh-editor** | 0.2.9 | Text editor for your terminal: easy, powerful and fast | https://getfresh.dev/ |
...
| **gdal** | 3.12.2-1 | A translator library for raster and vector geospatial data formats | https://gdal.org |
...
| **gmic** | 3.7.1 | Full-featured framework for image processing | https://gmic.eu |
| **gmic-gm** | 3.7.1 | Full-featured framework for image processing (GraphicsMagick variant) | https://gmic.eu |
...
| **hugo** | 0.157.0 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **jfrog-cli** | 2.93.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **kubo** | 0.40.0 | A peer-to-peer hypermedia distribution protocol | https://ipfs.io/ |
...
| **libblosc2** | 2.23.0-1 | A blocking, shuffling and loss-less compression library | https://www.blosc.org |
...
| **libfyaml** | 0.9.5 | Fully feature complete YAML parser and emitter | https://pantoniou.github.io/libfyaml/ |
| **libfyaml-static** | 0.9.5 | Static libraries for libfyaml | https://pantoniou.github.io/libfyaml/ |
...
| **libmaxminddb** | 1.13.2 | MaxMind GeoIP2 database - library and utilities | https://dev.maxmind.com/geoip/geoip2/ |
| **libmaxminddb-static** | 1.13.2 | Static libraries for libmaxminddb | https://dev.maxmind.com/geoip/geoip2/ |
| **libmaxminddb-tools** | 1.13.2 | A geoip lookup utility for MaxMind DB | https://dev.maxmind.com/geoip/geoip2/ |
...
| **libngtcp2-static** | 1.21.0 | Static libraries for libngtcp2 | https://github.com/ngtcp2/ngtcp2 |
...
| **mesa** | 26.0.1 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 26.0.1 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-opencl-icd-rusticl** | 26.0.1 | Mesa's Rusticl OpenCL ICD | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 26.0.1 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **neovim-nightly** | 0.12.0~dev-2425+gbe8969f4cc-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **oh-my-posh** | 29.7.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **oma** | 1.24.1 | oma is an attempt at reworking APT's interface | https://aosc.io/oma |
...
| **python-ruff** | 0.15.4 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **ruff** | 0.15.4 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **storj-uplink** | 1.148.3 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **teleport-tsh** | 18.7.1 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **tree-sitter-lua** | 0.5.0 | Lua grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-lua |
| **tree-sitter-markdown** | 0.5.3 | Markdown grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-markdown |
...
| **tree-sitter-vim** | 0.8.1 | Vimscript grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-vim |
