...
| **binaryen** | 128 | Binaryen is a compiler and toolchain infrastructure library for WebAssembly | https://github.com/WebAssembly/binaryen |
...
| **command-not-found** | 3.4.1-1 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **neovim-nightly** | 0.12.0~dev-2572+gf58d24040a-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **nodejs** | 25.8.1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
...
| **onnxruntime** | 1.24.3-2 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **python-onnxruntime** | 1.24.3-2 | Cross-platform, high performance ML inferencing and training accelerator (Python bindings) | https://onnxruntime.ai/ |
...
| **python-torch** | 2.10.0-2 | Tensors and Dynamic neural networks in Python | https://pytorch.org/ |
| **python-torch-static** | 2.10.0-2 | Static libraries for python-torch | https://pytorch.org/ |
...
| **python-torchvision** | 0.25.0-2 | Datasets, Transforms and Models specific to Computer Vision | https://github.com/pytorch/vision |
...
| **vim** | 9.2.0150 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **wakatime-cli** | 1.139.2 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **xxd** | 9.2.0150 | Hexdump utility from vim | https://www.vim.org |
