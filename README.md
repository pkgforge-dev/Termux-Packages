...
| **alsa-lib** | 1.2.15.2 | The Advanced Linux Sound Architecture (ALSA) - library | https://www.alsa-project.org |
...
| **assimp** | 6.0.2-2 | Library to import various well-known 3D model formats in an uniform manner | https://assimp.sourceforge.net/index.html |
...
| **bitcoin** | 30.1-1 | Bitcoin Core | https://bitcoincore.org/ |
...
| **boost** | 1:1.90.0 | Free peer-reviewed portable C++ source libraries | https://boost.org |
| **boost-headers** | 1:1.90.0 | Boost header files | https://boost.org |
| **boost-static** | 1:1.90.0 | Static libraries for boost | https://boost.org |
...
| **buf** | 1.63.0 | A new way of working with Protocol Buffers | https://buf.build |
...
| **chezmoi** | 2.69.1 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **clvk** | 0.0.20260111.104700 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
...
| **command-not-found** | 3.2-12 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **cookcli** | 0.19.3 | A suite of tools to create shopping lists and maintain food recipes | https://cooklang.org |
...
| **cppcheck** | 2.19.1 | tool for static C/C++ code analysis | https://github.com/danmar/cppcheck |
...
| **curl** | 8.18.0 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **emscripten** | 4.0.23 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 4.0.23 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 4.0.23 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 4.0.23 | Emscripten third party test suite files | https://emscripten.org |
...
| **fish** | 4.3.3 | The user-friendly command line shell | https://fishshell.com/ |
...
| **frp** | 0.66.0 | A fast reverse proxy to expose a local server behind a NAT or firewall to the internet | https://github.com/fatedier/frp |
...
| **gdal** | 3.12.1-1 | A translator library for raster and vector geospatial data formats | https://gdal.org |
...
| **gitoxide** | 0.49.0 | Rust implementation of Git | https://github.com/Byron/gitoxide |
...
| **hugo** | 0.154.4 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **i2pd** | 2.58.0-1 | A full-featured C++ implementation of the I2P router | https://i2pd.website/ |
| **i2pd-static** | 2.58.0-1 | Static libraries for i2pd | https://i2pd.website/ |
...
| **icu-devtools** | 78.2 | Development utilities for International Components for Unicode | http://site.icu-project.org/home |
...
| **imagemagick** | 7.1.2.12 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
...
| **jfrog-cli** | 2.88.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **just** | 1.46.0 | A handy way to save and run project-specific commands | https://just.systems |
...
| **libarrow-cpp** | 22.0.0-3 | C++ libraries for Apache Arrow | https://github.com/apache/arrow |
...
| **libc++utilities** | 5.32.1-1 | Useful C++ classes and routines such as argument parser, IO and conversion utilities | https://github.com/Martchus/cpp-utilities |
...
| **libcap-ng** | 2:0.9 | Library making programming with POSIX capabilities easier than traditional libcap | https://people.redhat.com/sgrubb/libcap-ng/ |
| **libcap-ng-static** | 2:0.9 | Static libraries for libcap-ng | https://people.redhat.com/sgrubb/libcap-ng/ |
...
| **libcurl** | 8.18.0 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.18.0 | Static libraries for libcurl | https://curl.se/ |
...
| **libfyaml** | 0.9.2 | Fully feature complete YAML parser and emitter | https://pantoniou.github.io/libfyaml/ |
| **libfyaml-static** | 0.9.2 | Static libraries for libfyaml | https://pantoniou.github.io/libfyaml/ |
...
| **libgrpc** | 1.76.0-2 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **liblua54** | 5.4.8-4 | Shared library for the Lua interpreter (v5.4.x) | https://www.lua.org/ |
| **liblua54-static** | 5.4.8-4 | Static libraries for liblua54 | https://www.lua.org/ |
| **liblua55** | 5.5.0 | Shared library for the Lua interpreter (v5.5.x) | https://www.lua.org/ |
| **liblua55-static** | 5.5.0 | Static libraries for liblua55 | https://www.lua.org/ |
| **libluajit** | 1:2.1.1767980792+g707c12b | Just-In-Time Compiler for Lua | https://luajit.org/ |
| **libluajit-static** | 1:2.1.1767980792+g707c12b | Static libraries for libluajit | https://luajit.org/ |
...
| **libosmium** | 2.22.0-5 | Library for reading from and writing to OSM files in XML and PBF formats | https://osmcode.org/libosmium/ |
...
| **libraw** | 0.21.5 | Library for reading RAW files from digital cameras | https://www.libraw.org/ |
| **libraw-static** | 0.21.5 | Static libraries for libraw | https://www.libraw.org/ |
...
| **librime** | 1.16.0-1 | A modular, extensible input method engine in cross-platform C++ code | https://rime.im/ |
...
| **libsodium** | 1.0.21 | Network communication, cryptography and signaturing library | https://libsodium.org/ |
| **libsodium-static** | 1.0.21 | Static libraries for libsodium | https://libsodium.org/ |
...
| **libtorrent** | 0.16.6 | Libtorrent BitTorrent library | https://github.com/rakshasa/rtorrent/wiki |
...
| **libtorrent-static** | 0.16.6 | Static libraries for libtorrent | https://github.com/rakshasa/rtorrent/wiki |
...
| **libtsduck** | 3.43.4549 | An extensible toolkit for MPEG transport streams | https://tsduck.io/ |
| **libtsduck-static** | 3.43.4549 | Static libraries for libtsduck | https://tsduck.io/ |
...
| **libx265** | 4.1-2 | H.265/HEVC video stream encoder library | http://x265.org/ |
| **libx265-static** | 4.1-2 | Static libraries for libx265 | http://x265.org/ |
...
| **lua-language-server** | 3.16.4 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **lua54** | 5.4.8-4 | Simple, extensible, embeddable programming language | https://www.lua.org/ |
| **lua55** | 5.5.0 | Simple, extensible, embeddable programming language | https://www.lua.org/ |
| **luajit** | 1:2.1.1767980792+g707c12b | Just-In-Time compiler for Lua - command line tool | https://luajit.org/ |
| **luajit-lgi** | 0.9.2 | Dynamic Lua binding to GObject libraries using GObject-Introspection | https://github.com/lgi-devs/lgi |
| **luarocks** | 3.13.0 | Deployment and management system for Lua modules | https://luarocks.org/ |
...
| **lux-cli** | 0.22.3-1 | A package manager for Lua, similar to luarocks | https://nvim-neorocks.github.io/ |
...
| **lyrebird** | 0.8.0 | A pluggable transport plugin for Tor | https://gitlab.torproject.org/tpo/anti-censorship/pluggable-transports |
...
| **mediamtx** | 1.15.6 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **mesa** | 25.3.3 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 25.3.3 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-opencl-icd-rusticl** | 25.3.3 | Mesa's Rusticl OpenCL ICD | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 25.3.3 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **miller** | 6.16.0 | Like awk, sed, cut, join, and sort for name-indexed data such as CSV, TSV, and tabular JSON | https://miller.readthedocs.io/ |
...
| **miniflux** | 2.2.16 | A minimalist and opinionated feed reader | https://miniflux.app/ |
...
| **monero** | 0.18.4.5-2 | A private, secure, untraceable, decentralised digital currency | https://getmonero.org/ |
...
| **neocmakelsp** | 0.9.1 | a cmake lsp based on tower-lsp and treesitter | https://neocmakelsp.github.io/ |
...
| **neovim-nightly** | 0.12.0~dev-2015+gba7e17160d-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **oh-my-posh** | 29.0.2 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **orbiton** | 2.70.5 | Small, fast and limited text editor | https://roboticoverlords.org/orbiton/ |
| **osmctools** | 0.9-3 | Simple tools for OpenStreetMap processing | https://gitlab.com/osm-c-tools/osmctools |
| **osmium-tool** | 1.18.0-5 | A multipurpose command line tool based on the Osmium Library | https://osmcode.org/osmium-tool/ |
...
| **plantuml** | 1.2026.0 | Draws UML diagrams, using a simple and human readable text description | https://plantuml.com/ |
...
| **pocketbase** | 0.35.1 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **postgis** | 3.6.1-1 | Spatial database extender for PostgreSQL object-relational database | https://postgis.net |
...
| **profanity** | 0.15.1-1 | Profanity is a console based XMPP client written in C using ncurses and libstrophe, inspired by Irssi | https://profanity-im.github.io |
...
| **proot** | 5.1.107-69 | Emulate chroot, bind mount and binfmt_misc for non-root users | https://proot-me.github.io/ |
| **proot-distro** | 4.37.0 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **pybind11** | 3.0.1-2 | A lightweight header-only library that exposes C++ types in Python and vice versa | https://pybind11.readthedocs.io/ |
...
| **python-grpcio** | 1.76.0-2 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **python-pyarrow** | 22.0.0-3 | Python bindings for Apache Arrow | https://github.com/apache/arrow |
...
| **python-sabyenc3** | 9.3.0 | C implementations of functions for use within SABnzbd | https://github.com/sabnzbd/sabctools |
...
| **recoll** | 1.43.9 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.43.9 | Python interface for Recoll | https://www.recoll.org/ |
...
| **remind** | 1:06.02.02 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **rtorrent** | 0.16.6 | Ncurses BitTorrent client based on libTorrent | https://rakshasa.github.io/rtorrent/ |
...
| **rust-analyzer** | 20260105 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **seanime** | 3.2.5 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **snapcast-client** | 0.34.0-2 | A multiroom client-server audio player (client) | https://github.com/badaix/snapcast |
| **snapcast-server** | 0.34.0-2 | A multiroom client-server audio player (server) | https://github.com/badaix/snapcast |
...
| **storj-uplink** | 1.144.4 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **supercollider** | 3.14.0-2 | A platform for audio synthesis and algorithmic composition | http://supercollider.github.io/ |
...
| **swi-prolog** | 10.1.1 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **syncthing** | 2.0.13 | Decentralized file synchronization | https://syncthing.net/ |
...
| **taglib** | 2.1.1-4 | A Library for reading and editing the meta-data of several popular audio formats. | http://taglib.github.io/ |
...
| **topgrade** | 16.8.0 | Upgrade all the things | https://github.com/topgrade-rs/topgrade/ |
...
| **tsduck-java** | 3.43.4549 | Java bindings for TSDuck | https://tsduck.io/ |
| **tsduck-plugins** | 3.43.4549 | Plugins for TSDuck | https://tsduck.io/ |
| **tsduck-python** | 3.43.4549 | Python bindings for TSDuck | https://tsduck.io/ |
| **tsduck-tools** | 3.43.4549 | Command line tools for TSDuck | https://tsduck.io/ |
...
| **v2ray** | 5.42.0 | A platform for building proxies to bypass network restrictions | https://www.v2fly.org/ |
...
| **vim** | 9.1.2050 | Vi IMproved - enhanced vi editor | https://www.vim.org |
| **virglrenderer** | 1.2.0-1 | A virtual 3D GPU for use inside qemu virtual machines | https://virgil3d.github.io/ |
...
| **vlc** | 3.0.23 | A popular libre and open source media player and multimedia engine | https://www.videolan.org/ |
| **vlc-static** | 3.0.23 | Static libraries for vlc | https://www.videolan.org/ |
...
| **vtm** | 2026.01.10 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **vulkan-headers** | 1.4.338 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **wget2** | 2.2.0-2 | The successor of GNU Wget, a file and recursive website downloader | https://gitlab.com/gnuwget/wget2 |
| **wget2-static** | 2.2.0-2 | Static libraries for wget2 | https://gitlab.com/gnuwget/wget2 |
...
| **x265** | 4.1-2 | H.265/HEVC video stream encoder tool | http://x265.org/ |
...
| **xmake** | 3.0.6 | A cross-platform build utility based on Lua | https://xmake.io/ |
...
| **xxd** | 9.1.2050 | Hexdump utility from vim | https://www.vim.org |
...
| **yazi** | 26.1.4 | Blazing fast terminal file manager written in Rust, based on async I/O | https://yazi-rs.github.io/ |
...
| **zola** | 0.22.0 | A fast static site generator in a single binary with everything built-in. | https://github.com/getzola/zola |
