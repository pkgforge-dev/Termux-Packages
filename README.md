...
| **exiftool** | 13.54 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **jackett** | 0.24.1526 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **neovim-nightly** | 0.13.0~dev-52+gf2cdf73afc-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **pyrefly** | 0.59.1 | A fast type checker and language server for Python | https://github.com/facebook/pyrefly.git |
...
| **uv** | 0.11.3 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **wakatime-cli** | 2.0.14 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
