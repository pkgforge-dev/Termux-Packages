...
| **deno** | 1:2.8.3 | A modern runtime for JavaScript and TypeScript | https://deno.land/ |
...
| **flyctl** | 0.4.60 | Command line tools for fly.io services | https://fly.io |
...
| **libexpat** | 2.8.1 | XML parsing C library | https://libexpat.github.io/ |
| **libexpat-static** | 2.8.1 | Static libraries for libexpat | https://libexpat.github.io/ |
...
| **librusty-v8** | 1:2.8.3 | High quality Rust bindings to V8's C++ API | https://deno.land/ |
...
| **snowflake** | 2.14.0 | Pluggable Transport using WebRTC, inspired by Flashproxy | https://snowflake.torproject.org/ |
| **snowflake-client** | 2.14.0 | Pluggable Transport using WebRTC, inspired by Flashproxy (Client) | https://snowflake.torproject.org/ |
| **snowflake-proxy** | 2.14.0 | Pluggable Transport using WebRTC, inspired by Flashproxy (Proxy) | https://snowflake.torproject.org/ |
...
| **ty** | 0.0.53 | An extremely fast Python type checker and language server, written in Rust | https://github.com/astral-sh/ty |
