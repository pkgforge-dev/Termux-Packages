...
| **aapt** | 13.0.0.6-19 | Android Asset Packaging Tool | https://elinux.org/Android_aapt |
| **aapt2** | 13.0.0.6-19 | AAPT2 (Android Asset Packaging Tool) | https://elinux.org/Android_aapt |
...
| **aidl** | 13.0.0.6-19 | Android Interface Definition Language (AIDL) | https://elinux.org/Android_aapt |
...
| **clang** | 20.1.8-2 | C language frontend for LLVM | https://clang.llvm.org/ |
...
| **cloudflared** | 2025.8.0 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **command-not-found** | 3.1-7 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **fastfetch** | 2.50.1 | A maintained, feature-rich and performance oriented, neofetch like system information tool | https://github.com/fastfetch-cli/fastfetch |
...
| **glab-cli** | 1.67.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **go-musicfox** | 4.6.6 | A netease music player in terminal. | https://github.com/go-musicfox/go-musicfox |
...
| **googletest** | 1.17.0 | Google C++ testing framework | https://github.com/google/googletest |
...
| **harfbuzz** | 11.4.1 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 11.4.1 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 11.4.1 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **helm** | 3.18.5 | Helm helps you manage Kubernetes applications | https://helm.sh |
...
| **imagemagick** | 7.1.2.1 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.2.1 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **jackett** | 0.22.2286 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **libcompiler-rt** | 20.1.8-2 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libllvm** | 20.1.8-2 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 20.1.8-2 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libpolly** | 20.1.8-2 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **lld** | 20.1.8-2 | LLVM-based linker | https://clang.llvm.org/ |
| **llvm** | 20.1.8-2 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
...
| **llvm-tools** | 20.1.8-2 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 20.1.8-2 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **moor** | 2.0.4 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **oh-my-posh** | 26.19.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **oxc-language-server** | 1.11.2 | Oxc JavaScript linter language server | https://oxc.rs/ |
| **oxlint** | 1.11.2 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **pocketbase** | 0.29.2 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **proot-distro** | 4.28.0 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **python-ruff** | 0.12.8 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **python-yt-dlp** | 2025.08.11 | A youtube-dl fork with additional features and fixes | https://github.com/yt-dlp/yt-dlp |
...
| **railway-cli** | 4.6.3 | This is the command line interface for Railway | https://railway.app |
...
| **ruff** | 0.12.8 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust-analyzer** | 20250811-1 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **sing-box** | 1.12.1 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **snapcast-client** | 0.32.3 | A multiroom client-server audio player (client) | https://github.com/badaix/snapcast |
| **snapcast-server** | 0.32.3 | A multiroom client-server audio player (server) | https://github.com/badaix/snapcast |
...
| **syncthing** | 2.0.1 | Decentralized file synchronization | https://syncthing.net/ |
...
| **uv** | 0.8.10 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vtm** | 2025.08.13 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **vulkan-headers** | 1.4.325 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.325 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.325 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.325 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
| **vulkan-validation-layers** | 1.4.325 | Vulkan Validation Layers | https://github.com/KhronosGroup/Vulkan-ValidationLayers |
...
| **wtfutil** | 0.46.0 | The personal information dashboard for your terminal | https://wtfutil.com/ |
...
| **zrok** | 1.1.2 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
