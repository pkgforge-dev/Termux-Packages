...
| **buf** | 1.59.0 | A new way of working with Protocol Buffers | https://buf.build |
...
| **cargo-leptos** | 0.2.46 | Build tool for the Rust framework Leptos | https://github.com/leptos-rs/cargo-leptos |
...
| **clang** | 21.1.4 | C language frontend for LLVM | https://clang.llvm.org/ |
...
| **command-not-found** | 3.2-1 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **dnsutils** | 9.20.15 | Clients provided with BIND | https://www.isc.org/bind/ |
...
| **edbrowse** | 3.8.13 | Line based editor, browser, and mail client | https://edbrowse.org/ |
...
| **elixir** | 1.19.1 | Elixir is a dynamic, functional language designed for building scalable and maintainable applications | https://elixir-lang.org/ |
...
| **emscripten** | 4.0.18 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 4.0.18 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 4.0.18 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 4.0.18 | Emscripten third party test suite files | https://emscripten.org |
...
| **exiftool** | 13.40 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **gdk-pixbuf** | 2.44.4 | Library for image loading and manipulation | https://wiki.gnome.org/Projects/GdkPixbuf |
...
| **gh** | 2.82.1 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **gitea** | 1.24.7 | Git with a cup of tea, painless self-hosted git service | https://gitea.io |
...
| **gnunet** | 0.25.2-1 | A framework for secure peer-to-peer networking | https://gnunet.org |
...
| **guile** | 3.0.10-1 | Portable, embeddable Scheme implementation written in C | http://www.gnu.org/software/guile/ |
| **guile-static** | 3.0.10-1 | Static libraries for guile | http://www.gnu.org/software/guile/ |
...
| **hcloud** | 1.55.0 | Hetzner Cloud command line client | https://github.com/hetznercloud/cli |
...
| **hugo** | 0.152.2 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **jackett** | 0.24.191 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jql** | 8.0.9 | A JSON Query Language CLI tool | https://github.com/yamafaktory/jql |
...
| **just** | 1.43.0-1 | A handy way to save and run project-specific commands | https://just.systems |
...
| **kibi** | 0.3.0 | A tiny terminal text editor, written in Rust | https://github.com/ilai-deutel/kibi |
...
| **kubo** | 0.38.1 | A peer-to-peer hypermedia distribution protocol | https://ipfs.io/ |
...
| **ledger** | 3.4.1 | Powerful, double-entry accounting system | https://www.ledger-cli.org |
...
| **libclc** | 21.1.3 | Open source implementation of the library requirements of the OpenCL C programming language | https://libclc.llvm.org/ |
...
| **libcommons-lang3-java** | 3.19.0 | A host of helper utilities for the java.lang API | https://commons.apache.org/proper/commons-lang/ |
| **libcompiler-rt** | 21.1.4 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libdrm** | 2.4.127 | Userspace interface to kernel DRM services | https://dri.freedesktop.org/wiki/ |
| **libduckdb** | 1.4.1 | An in-process SQL OLAP database management system | https://duckdb.org/ |
| **libduckdb-static** | 1.4.1 | Static libraries for libduckdb | https://duckdb.org/ |
...
| **libllvm** | 21.1.4 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 21.1.4 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libnats-c** | 3.11.0 | A C client for the NATS messaging system | https://nats-io.github.io/nats.c/ |
| **libnats-c-static** | 3.11.0 | Static libraries for libnats-c | https://nats-io.github.io/nats.c/ |
...
| **libpolly** | 21.1.4 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **librsvg** | 2.61.2-1 | Library to render SVG files using cairo | https://wiki.gnome.org/action/show/Projects/LibRsvg |
...
| **libspdlog** | 1.16.0 | Very fast, header-only/compiled, C++ logging library | https://github.com/gabime/spdlog |
...
| **libtorrent** | 0.16.1 | Libtorrent BitTorrent library | https://github.com/rakshasa/rtorrent/wiki |
...
| **libtorrent-static** | 0.16.1 | Static libraries for libtorrent | https://github.com/rakshasa/rtorrent/wiki |
...
| **libunbound** | 1.24.1 | A validating, recursive, caching DNS resolver | https://unbound.net/ |
| **libunbound-static** | 1.24.1 | Static libraries for libunbound | https://unbound.net/ |
...
| **libvips** | 8.17.2-1 | A fast image processing library with low memory needs | https://libvips.github.io/libvips/ |
...
| **libxml2** | 2.15.0 | Library for parsing XML documents | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
| **libxml2-python** | 2.15.0 | Python bindings for libxml2 | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
| **libxml2-utils** | 2.15.0 | XML utilities | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
...
| **lld** | 21.1.4 | LLVM-based linker | https://clang.llvm.org/ |
| **lldb** | 21.1.4 | LLVM-based debugger | https://clang.llvm.org/ |
| **llvm** | 21.1.4 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
| **llvm-mingw-w64** | 20251007 | MinGW-w64 toolchain based on LLVM | https://github.com/mstorsjo/llvm-mingw |
| **llvm-mingw-w64-libcompiler-rt** | 20251007 | Compiler runtime libraries for LLVM-MinGW | https://github.com/mstorsjo/llvm-mingw |
| **llvm-mingw-w64-tools** | 12.0.0-1 | MinGW-w64 tools for LLVM-MinGW | https://github.com/mstorsjo/llvm-mingw |
| **llvm-mingw-w64-ucrt** | 20251007 | MinGW-w64 runtime for LLVM-MinGW | https://github.com/mstorsjo/llvm-mingw |
| **llvm-tools** | 21.1.4 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 21.1.4 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **matplotlib** | 3.10.7 | A comprehensive library for creating static, animated, and interactive visualizations in Python | https://matplotlib.org/ |
...
| **mautrix-whatsapp** | 0.2510.0 | A Matrix-WhatsApp puppeting bridge | https://maunium.net/go/mautrix-whatsapp/ |
...
| **mdbook-mermaid** | 0.16.2 | A preprocessor for mdbook to add mermaid support | https://github.com/badboy/mdbook-mermaid |
...
| **mediamtx** | 1.15.3 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **mesa** | 25.2.5 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 25.2.5 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-opencl-icd-rusticl** | 25.2.5 | Mesa's Rusticl OpenCL ICD | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 25.2.5 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **mlir** | 21.1.4 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
...
| **monero** | 0.18.4.3 | A private, secure, untraceable, decentralised digital currency | https://getmonero.org/ |
...
| **moor** | 2.7.1 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **mpd** | 0.24.6 | Music player daemon | https://www.musicpd.org |
...
| **mpv** | 0.40.0-2 | Command-line media player | https://mpv.io/ |
...
| **msedit** | 1.2.1 | A simple editor for simple needs (Microsoft Edit) | https://github.com/microsoft/edit |
...
| **mutt** | 2.2.15 | Mail client with patches from neomutt | http://www.mutt.org/ |
...
| **mympd** | 22.1.2 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **oma** | 1.22.5 | oma is an attempt at reworking APT's interface | https://aosc.io/oma |
...
| **openjdk-17** | 17.0.17 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-17-source** | 17.0.17 | Source files for openjdk-17 | https://openjdk.java.net |
| **openjdk-17-x** | 17.0.17 | Portion of openjdk-17 requiring X11 functionality | https://openjdk.java.net |
...
| **openlist** | 4.1.5 | A file list program that supports multiple storage | https://oplist.org/ |
...
| **pastel** | 0.11.0 | A command-line tool to generate, analyze, convert and manipulate colors | https://github.com/sharkdp/pastel |
...
| **pcscd** | 2.4.0 | Middleware to access a smart card using SCard API (PC/SC). (daemon side) | https://pcsclite.apdu.fr/ |
...
| **perl** | 5.40.3-1 | Capable, feature-rich programming language | https://www.perl.org/ |
...
| **php-zephir-parser** | 1.8.0 | The Zephir Parser delivered as a C extension for the PHP language | https://github.com/phalcon/php-zephir-parser |
...
| **plantuml** | 1.2025.9 | Draws UML diagrams, using a simple and human readable text description | https://plantuml.com/ |
...
| **pocketbase** | 0.31.0 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **proot-distro** | 4.31.0 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **pv** | 1.9.44 | Terminal-based tool for monitoring the progress of data through a pipeline | https://www.ivarch.com/programs/pv.shtml |
...
| **python-msgpack** | 1.1.2 | MessagePack serializer implementation for Python | https://github.com/msgpack/msgpack-python |
...
| **python-yt-dlp** | 2025.10.22 | A youtube-dl fork with additional features and fixes | https://github.com/yt-dlp/yt-dlp |
...
| **pyunbound** | 1.24.1 | Python bindings for Unbound | https://unbound.net/ |
...
| **qalc** | 5.8.0 | Powerful and easy to use command line calculator | https://qalculate.github.io/ |
| **qalc-static** | 5.8.0 | Static libraries for qalc | https://qalculate.github.io/ |
...
| **railway-cli** | 4.11.0 | This is the command line interface for Railway | https://railway.app |
...
| **rapidjson** | 1.1.0-6 | Fast JSON parser/generator for C++ with SAX/DOM style API | https://github.com/Tencent/rapidjson/ |
...
| **remind** | 1:06.01.07 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **rtorrent** | 0.16.1 | Ncurses BitTorrent client based on libTorrent | https://rakshasa.github.io/rtorrent/ |
...
| **ruff** | 0.14.2 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust** | 1.90.0+really1.90.0-1 | Systems programming language focused on safety, speed and concurrency | https://www.rust-lang.org/ |
| **rust-analyzer** | 20251027 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **rust-docs** | 1.90.0+really1.90.0-1 | Rust documentation | https://www.rust-lang.org/ |
| **rust-src** | 1.90.0+really1.90.0-1 | Rust source code files | https://www.rust-lang.org/ |
| **rust-std-aarch64-linux-android** | 1.90.0+really1.90.0-1 | Rust std for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.90.0+really1.90.0-1 | Rust std for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.90.0+really1.90.0-1 | Rust std for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.90.0+really1.90.0-1 | Rust std for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip1** | 1.90.0+really1.90.0-1 | Rust std for target wasm32-wasip1 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip2** | 1.90.0+really1.90.0-1 | Rust std for target wasm32-wasip2 | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.90.0+really1.90.0-1 | Rust std for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.90.0+really1.90.0-1 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.90.0+really1.90.0-1 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **sendme** | 0.30.0 | A tool to send files and directories, based on iroh | https://github.com/n0-computer/sendme |
...
| **shaderc** | 2025.4-1 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **simdjson** | 4.0.7 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
...
| **sing-box** | 1.12.11 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **snapcast-client** | 0.34.0 | A multiroom client-server audio player (client) | https://github.com/badaix/snapcast |
| **snapcast-server** | 0.34.0 | A multiroom client-server audio player (server) | https://github.com/badaix/snapcast |
...
| **spirv-llvm-translator** | 21.1.1 | SPIR-V LLVM Translator | https://github.com/KhronosGroup/SPIRV-LLVM-Translator |
| **spirv-tools** | 1.4.328.1 | SPIR-V Tools | https://github.com/KhronosGroup/SPIRV-Tools |
...
| **squid** | 7.2 | Full-featured Web proxy cache server | http://www.squid-cache.org |
...
| **starship** | 1.24.0 | A minimal, blazing fast, and extremely customizable prompt for any shell | https://starship.rs |
...
| **storj-uplink** | 1.139.6 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **stunnel** | 5.76 | Socket wrapper which can provide TLS support to ordinary applications | https://www.stunnel.org/ |
| **stunnel-static** | 5.76 | Static libraries for stunnel | https://www.stunnel.org/ |
| **stuntman** | 1.2.16-6 | An open source STUN server | https://www.stunprotocol.org/ |
| **stylua** | 2.3.0 | An opinionated Lua code formatter | https://github.com/JohnnyMorganz/StyLua |
...
| **swi-prolog** | 9.3.33 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **teleport-tsh** | 18.2.10 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **timg** | 1.6.3 | A terminal image and video viewer | https://timg.sh/ |
...
| **tsduck-java** | 3.42.4421 | Java bindings for TSDuck | https://tsduck.io/ |
| **tsduck-plugins** | 3.42.4421 | Plugins for TSDuck | https://tsduck.io/ |
| **tsduck-python** | 3.42.4421 | Python bindings for TSDuck | https://tsduck.io/ |
| **tsduck-tools** | 3.42.4421 | Command line tools for TSDuck | https://tsduck.io/ |
...
| **typst** | 0.14.0 | A new markup-based typesetting system that is powerful and easy to learn | https://typst.app/ |
...
| **unbound** | 1.24.1 | Unbound command-line tools | https://unbound.net/ |
...
| **utf8proc** | 2.11.0 | Library for processing UTF-8 Unicode data | https://github.com/JuliaLang/utf8proc |
| **utf8proc-static** | 2.11.0 | Static libraries for utf8proc | https://github.com/JuliaLang/utf8proc |
...
| **vale** | 3.13.0 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
...
| **valkey** | 8.1.4-1 | In-memory data structure store used as a database, cache and message broker | https://valkey.io/ |
...
| **vgmstream** | 2055 | A library for playback of various streamed audio formats used in video games | https://github.com/vgmstream/vgmstream |
...
| **vim** | 9.1.1850 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **vtm** | 2025.10.25 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **vulkan-headers** | 1.4.330 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.330 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.330 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.330 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
| **vulkan-validation-layers** | 1.4.330 | Vulkan Validation Layers | https://github.com/KhronosGroup/Vulkan-ValidationLayers |
...
| **wasm-component-ld** | 0.5.18 | Command line linker for creating WebAssembly components | https://github.com/bytecodealliance/wasm-component-ld |
...
| **xmake** | 3.0.4 | A cross-platform build utility based on Lua | https://xmake.io/ |
| **xmlsec** | 1.3.8 | XML Security Library | https://www.aleksey.com/xmlsec/ |
| **xmlsec-static** | 1.3.8 | Static libraries for xmlsec | https://www.aleksey.com/xmlsec/ |
...
| **xxd** | 9.1.1850 | Hexdump utility from vim | https://www.vim.org |
...
| **yosys** | 0.58 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
| **youtubedr** | 2.10.4-1 | Download youtube video in Golang | https://github.com/kkdai/youtube |
| **yq** | 4.48.1 | A lightweight and portable command-line YAML, JSON and XML processor | https://mikefarah.gitbook.io/yq/ |
