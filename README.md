...
| **glab-cli** | 1.60.2 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **libgrpc** | 1.73.0 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **lua-language-server** | 3.14.0 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **moar** | 1.31.10 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moar |
...
| **oh-my-posh** | 26.9.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **python-yt-dlp** | 2025.06.09 | A youtube-dl fork with additional features and fixes | https://github.com/yt-dlp/yt-dlp |
...
| **shaderc** | 2025.2 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **unrar** | 7.1.7 | Tool for extracting files from .rar archives | https://www.rarlab.com/ |
...
| **uv** | 0.7.14 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **z3** | 4.15.1 | Z3 is a theorem prover from Microsoft Research | https://github.com/Z3Prover/z3 |
