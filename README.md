...
| **gegl** | 0.4.68 | Data flow based image processing framework | https://gegl.org/ |
...
| **lexbor** | 2.7.0 | Fast embeddable web browser engine written in C with no dependencies | https://lexbor.com |
...
| **python-ruff** | 0.15.6 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **ruff** | 0.15.6 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **vale** | 3.14.0 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
...
| **yt-dlp-ejs** | 0.6.0 | External JavaScript for yt-dlp supporting many runtimes | https://github.com/yt-dlp/ejs |
