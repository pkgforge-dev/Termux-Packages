...
| **cloudflared** | 2026.5.2 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **frei0r-plugins** | 3.2.0 | Minimalistic plugin API for video effects | https://www.dyne.org/software/frei0r/ |
...
| **libmsgpack** | 7.0.0 | MessagePack implementation for C | https://github.com/msgpack/msgpack-c/ |
| **libmsgpack-cxx** | 8.0.0 | msgpack for C++ | https://msgpack.org/ |
| **libmsgpack-static** | 7.0.0 | Static libraries for libmsgpack | https://github.com/msgpack/msgpack-c/ |
...
| **proot-distro** | 5.1.5 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **seanime** | 3.8.4 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **ty** | 0.0.45 | An extremely fast Python type checker and language server, written in Rust | https://github.com/astral-sh/ty |
