...
| **atuin** | 18.9.0 | Magical shell history | https://atuin.sh/ |
...
| **lux-cli** | 0.18.6 | A package manager for Lua, similar to luarocks | https://nvim-neorocks.github.io/ |
...
| **uv** | 0.9.4 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
