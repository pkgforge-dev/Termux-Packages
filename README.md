...
| **aspell-static** | 0.60.8.1-2 | Static libraries for aspell | http://aspell.net |
...
| **broot** | 1.54.0 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **chezmoi** | 2.68.0 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **cups** | 2.4.16 | Common UNIX Printing System | https://www.cups.org/ |
| **cups-pdf** | 3.0.1-1 | CUPS PDF backend | https://www.cups-pdf.de/ |
| **cups-static** | 2.4.16 | Static libraries for cups | https://www.cups.org/ |
...
| **exiftool** | 13.43 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **frei0r-plugins** | 2.5.1 | Minimalistic plugin API for video effects | https://www.dyne.org/software/frei0r/ |
...
| **jackett** | 0.24.402 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **libarrow-cpp** | 22.0.0-2 | C++ libraries for Apache Arrow | https://github.com/apache/arrow |
...
| **libc++utilities** | 5.32.0 | Useful C++ classes and routines such as argument parser, IO and conversion utilities | https://github.com/Martchus/cpp-utilities |
...
| **libtorrent** | 0.16.5 | Libtorrent BitTorrent library | https://github.com/rakshasa/rtorrent/wiki |
...
| **libtorrent-static** | 0.16.5 | Static libraries for libtorrent | https://github.com/rakshasa/rtorrent/wiki |
...
| **libxslt** | 1.1.45 | XSLT processing library | http://xmlsoft.org/libxslt/ |
...
| **mesa** | 25.3.1 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 25.3.1 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-opencl-icd-rusticl** | 25.3.1 | Mesa's Rusticl OpenCL ICD | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 25.3.1 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **oh-my-posh** | 28.1.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **pocketbase** | 0.34.2 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **python-greenlet** | 3.3.0 | Lightweight coroutines for in-process concurrent programming | https://github.com/python-greenlet/greenlet |
...
| **qemu-system-i386-headless** | 1:10.1.2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-m68k-headless** | 1:10.1.2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc-headless** | 1:10.1.2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc64-headless** | 1:10.1.2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv32-headless** | 1:10.1.2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv64-headless** | 1:10.1.2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless** | 1:10.1.2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-user-aarch64** | 1:10.1.2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-arm** | 1:10.1.2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-i386** | 1:10.1.2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-m68k** | 1:10.1.2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc** | 1:10.1.2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc64** | 1:10.1.2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv32** | 1:10.1.2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv64** | 1:10.1.2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-x86-64** | 1:10.1.2 | QEMU Linux user mode emulator | https://www.qemu.org |
...
| **restish** | 0.21.0-cifix-0 | A CLI for interacting with REST-ish HTTP APIs | https://github.com/danielgtaylor/restish |
...
| **solidity** | 0.8.31 | An Ethereum smart contract-oriented language | https://www.soliditylang.org/ |
...
| **storj-uplink** | 1.143.2 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **teleport-tsh** | 18.4.2 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **vim** | 9.1.1950 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **wakatime-cli** | 1.132.0 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
