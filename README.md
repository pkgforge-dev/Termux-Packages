...
| **appstream** | 1.0.4-1 | Provides a standard for creating app stores across distributions | https://www.freedesktop.org/wiki/Distributions/AppStream/ |
...
| **b3sum** | 1.8.1 | A command line utility for calculating BLAKE3 hashes, similar to Coreutils tools like b2sum or md5sum | https://github.com/BLAKE3-team/BLAKE3/tree/master/b3sum |
...
| **boinc** | 8.2.1 | Open-source software for volunteer computing | https://boinc.berkeley.edu/ |
...
| **broot** | 1.46.0 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **buf** | 1.52.1 | A new way of working with Protocol Buffers | https://buf.build |
...
| **clang** | 20.1.3 | C language frontend for LLVM | https://clang.llvm.org/ |
...
| **cloudflared** | 2025.4.0 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
| **clpeak** | 1.1.4 | A tool which profiles OpenCL devices to find their peak capacities | https://github.com/krrishnarraj/clpeak |
| **clvk** | 0.0.20250414.161857 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
...
| **emscripten** | 4.0.6 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 4.0.6 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 4.0.6 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 4.0.6 | Emscripten third party test suite files | https://emscripten.org |
...
| **eza** | 0.21.1 | A modern replacement for ls | https://github.com/eza-community/eza |
...
| **fastfetch** | 2.41.0 | A maintained, feature-rich and performance oriented, neofetch like system information tool | https://github.com/fastfetch-cli/fastfetch |
...
| **ffmpeg** | 7.1.1-2 | Tools and libraries to manipulate a wide range of multimedia formats and protocols | https://ffmpeg.org |
...
| **fish** | 4.0.1 | The user-friendly command line shell | https://fishshell.com/ |
...
| **frp** | 0.62.0 | A fast reverse proxy to expose a local server behind a NAT or firewall to the internet | https://github.com/fatedier/frp |
...
| **fzf** | 0.61.1 | Command-line fuzzy finder | https://junegunn.github.io/fzf/ |
...
| **gdk-pixbuf** | 2.42.12-1 | Library for image loading and manipulation | https://wiki.gnome.org/Projects/GdkPixbuf |
...
| **gh** | 2.70.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **glib** | 2.84.1 | Library providing core building blocks for libraries and applications written in C | https://developer.gnome.org/glib/ |
| **glib-bin** | 2.84.1 | Programs for the GLib library | https://developer.gnome.org/glib/ |
| **glib-cross** | 2.84.1 | glib for host (NOT for Termux) | https://developer.gnome.org/glib/ |
...
| **golang** | 3:1.24.1 | Go programming language compiler | https://golang.org/ |
| **golang-doc** | 3:1.24.1 | Go programming language - documentation | https://golang.org/ |
...
| **gst-plugins-bad** | 1.26.0-1 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
...
| **gst-plugins-good** | 1.26.0-1 | GStreamer Good Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-ugly** | 1.26.0 | GStreamer Ugly Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-python** | 1.26.0 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
| **gstreamer** | 1.26.0 | Open source multimedia framework | https://gstreamer.freedesktop.org/ |
...
| **harfbuzz** | 11.1.0 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 11.1.0 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 11.1.0 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **hugo** | 0.146.5 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **jackett** | 0.22.1795 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **k9s** | 0.50.3 | Kubernetes CLI To Manage Your Clusters In Style! | https://k9scli.io |
...
| **kubelogin** | 1.32.3 | A kubectl plugin for Kubernetes OpenID Connect (OIDC) authentication | https://github.com/int128/kubelogin |
...
| **libcompiler-rt** | 20.1.3 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libftxui** | 6.0.2 | A simple C++ library for terminal based user interface | https://github.com/ArthurSonzogni/FTXUI |
...
| **libllvm** | 20.1.3 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 20.1.3 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libmediainfo** | 25.03 | Library for reading information from media files | https://mediaarea.net/en/MediaInfo |
| **libmediainfo-static** | 25.03 | Static libraries for libmediainfo | https://mediaarea.net/en/MediaInfo |
...
| **libpolly** | 20.1.3 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **libtorrent** | 0.15.2 | Libtorrent BitTorrent library | https://github.com/rakshasa/rtorrent/wiki |
...
| **libtorrent-static** | 0.15.2 | Static libraries for libtorrent | https://github.com/rakshasa/rtorrent/wiki |
...
| **libxml2** | 2.14.1 | Library for parsing XML documents | http://www.xmlsoft.org |
| **libxml2-python** | 2.14.1 | Python bindings for libxml2 | http://www.xmlsoft.org |
| **libxml2-python-static** | 2.14.1 | Static libraries for libxml2-python | http://www.xmlsoft.org |
| **libxml2-static** | 2.14.1 | Static libraries for libxml2 | http://www.xmlsoft.org |
| **libxml2-utils** | 2.14.1 | XML utilities | http://www.xmlsoft.org |
...
| **lld** | 20.1.3 | LLVM-based linker | https://clang.llvm.org/ |
| **llvm** | 20.1.3 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
...
| **llvm-tools** | 20.1.3 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 20.1.3 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **manpages** | 6.13 | Man pages for linux kernel and C library interfaces | https://www.kernel.org/doc/man-pages/ |
...
| **mediainfo** | 25.03 | Command-line utility for reading information from media files | https://mediaarea.net/en/MediaInfo |
...
| **mlir** | 20.1.3 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
...
| **ncdu2** | 2.8 | Disk usage analyzer | https://dev.yorhel.nl/ncdu |
...
| **nodejs-lts** | 22.14.0-1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
...
| **nushell** | 0.103.0 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **o-editor** | 2.68.9 | Small, fast and limited text editor | https://github.com/xyproto/o |
...
| **oh-my-posh** | 25.15.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **parallel** | 20250322 | GNU Parallel is a shell tool for executing jobs in parallel using one or more machines | https://www.gnu.org/software/parallel/ |
...
| **pocketbase** | 0.27.0 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **proot-distro** | 4.24.0 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **python-greenlet** | 3.2.0 | Lightweight coroutines for in-process concurrent programming | https://github.com/python-greenlet/greenlet |
| **python-grpcio** | 1.71.0 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **python-lxml** | 5.3.2-1 | Python binding for the libxml2 and libxslt libraries | https://github.com/lxml/lxml |
| **python-msgpack** | 1.1.0-1 | MessagePack serializer implementation for Python | https://github.com/msgpack/msgpack-python |
| **python-numpy** | 2.2.4 | The fundamental package for scientific computing with Python | https://numpy.org/ |
| **python-numpy-static** | 2.2.4 | Static libraries for python-numpy | https://numpy.org/ |
| **python-onnxruntime** | 1.21.0 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
| **python-pillow** | 11.1.0-1 | Python Imaging Library | https://python-pillow.org/ |
| **python-pip** | 25.0.1-1 | The PyPA recommended tool for installing Python packages | https://pip.pypa.io/ |
...
| **python-yt-dlp** | 2025.03.31 | A youtube-dl fork with additional features and fixes | https://github.com/yt-dlp/yt-dlp |
...
| **railway-cli** | 4.0.0 | This is the command line interface for Railway | https://railway.app |
...
| **remind** | 1:05.03.05 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **ruff** | 0.11.6 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **seanime** | 2.8.1 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **sing-box** | 1.11.8 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **uv** | 0.6.9 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
| **uwsgi** | 2.0.29-1 | uWSGI application server container | https://projects.unbit.it/uwsgi |
| **v2ray** | 5.30.0 | A platform for building proxies to bypass network restrictions | https://www.v2fly.org/ |
...
| **vim** | 9.1.1300 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **xxd** | 9.1.1300 | Hexdump utility from vim | https://www.vim.org |
...
| **zk** | 0.15.0 | A plain text note-taking assistant | https://zk-org.github.io/zk/ |
...
| **zrok** | 1.0.2 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
