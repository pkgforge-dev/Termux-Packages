...
| **borgbackup** | 1.4.4-3 | Deduplicating and compressing backup program | https://www.borgbackup.org/ |
...
| **command-not-found** | 3.5.0-2 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **just** | 1.56.0 | A handy way to save and run project-specific commands | https://just.systems |
...
| **libarrow-cpp** | 25.0.0 | C++ libraries for Apache Arrow | https://github.com/apache/arrow |
...
| **libc++utilities** | 5.34.2 | Useful C++ classes and routines such as argument parser, IO and conversion utilities | https://github.com/Martchus/cpp-utilities |
...
| **oh-my-posh** | 29.32.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **osm2pgsql** | 2.3.1 | osm2pgsql imports OpenStreetMap (OSM) data into a PostgreSQL/PostGIS database | https://osm2pgsql.org/ |
...
| **php-zephir-parser** | 2.2.0 | The Zephir Parser delivered as a C extension for the PHP language | https://github.com/phalcon/php-zephir-parser |
...
| **proot** | 5.1.107.84 | Emulate chroot, bind mount and binfmt_misc for non-root users | https://proot-me.github.io/ |
...
| **python-pyarrow** | 25.0.0 | Python bindings for Apache Arrow | https://github.com/apache/arrow |
...
| **swi-prolog** | 10.1.11-1 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **thrift** | 0.24.0 | Scalable cross-language services framework for IPC/RPC | https://thrift.apache.org |
