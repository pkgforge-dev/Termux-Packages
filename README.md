...
| **assimp** | 6.0.1 | Library to import various well-known 3D model formats in an uniform manner | https://assimp.sourceforge.net/index.html |
...
| **gst-plugins-base** | 1.26.2 | GStreamer base plug-ins | https://gstreamer.freedesktop.org/ |
...
| **oh-my-posh** | 26.4.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **tree-sitter-markdown** | 0.5.0-1 | Markdown grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-markdown |
| **tree-sitter-markdown-static** | 0.3.2 | Static libraries for tree-sitter-markdown | https://github.com/tree-sitter-grammars |
| **tree-sitter-parsers** | 0.0.3 | A metapackage that provides commonly used treesitter parsers | https://github.com/termux/termux-packages |
