...
| **lgogdownloader** | 3.17 | Open source downloader to GOG.com for Linux users using the same API as the official GOGDownloader | https://sites.google.com/site/gogdownloader/ |
...
| **libarrow-cpp** | 19.0.1-2 | C++ libraries for Apache Arrow | https://github.com/apache/arrow |
...
| **libosmium** | 2.22.0 | Library for reading from and writing to OSM files in XML and PBF formats | https://osmcode.org/libosmium/ |
...
| **monero** | 0.18.3.4-2 | A private, secure, untraceable, decentralised digital currency | https://getmonero.org/ |
...
| **ncmpcpp** | 0.10.1-3 | NCurses Music Player Client (Plus Plus) | https://rybczak.net/ncmpcpp/ |
...
| **openfoam** | 2412 | OpenFOAM is a CFD software written in C++ | https://www.openfoam.com |
...
| **osmium-tool** | 1.18.0 | A multipurpose command line tool based on the Osmium Library | https://osmcode.org/osmium-tool/ |
...
| **python-pyarrow** | 19.0.1-2 | Python bindings for Apache Arrow | https://github.com/apache/arrow |
...
| **snapcast-client** | 0.31.0-1 | A multiroom client-server audio player (client) | https://github.com/badaix/snapcast |
| **snapcast-server** | 0.31.0-1 | A multiroom client-server audio player (server) | https://github.com/badaix/snapcast |
...
| **solidity** | 0.8.29 | An Ethereum smart contract-oriented language | https://solidity.readthedocs.io |
...
| **vera** | 1.3.0-6 | A programmable tool for verification, analysis and transformation of C++ source code | https://bitbucket.org/verateam/vera |
...
| **yosys** | 0.51 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
