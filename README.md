...
| **moor** | 2.4.1 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **oh-my-posh** | 26.26.3 | A prompt theme engine for any shell. | https://ohmyposh.dev |
