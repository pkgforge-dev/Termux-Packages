...
| **ada** | 3.2.5 | WHATWG-compliant and fast URL parser written in modern C++ | https://github.com/ada-url/ada |
...
| **command-not-found** | 3.1-3 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **curl** | 8.14.1 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **fastfetch** | 2.47.0 | A maintained, feature-rich and performance oriented, neofetch like system information tool | https://github.com/fastfetch-cli/fastfetch |
...
| **gradle** | 1:8.14.3 | Powerful build system for the JVM | https://gradle.org/ |
...
| **gst-libav** | 1.26.3 | GStreamer Libav plug-in contains one plugin with a set of elements using the Libav library code | https://gstreamer.freedesktop.org/modules/gst-libav.html |
| **gst-plugins-bad** | 1.26.3 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-base** | 1.26.3 | GStreamer base plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-good** | 1.26.3 | GStreamer Good Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-ugly** | 1.26.3 | GStreamer Ugly Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-python** | 1.26.3 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
| **gstreamer** | 1.26.3 | Open source multimedia framework | https://gstreamer.freedesktop.org/ |
...
| **jackett** | 0.22.2161 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **just** | 1.42.2 | A handy way to save and run project-specific commands | https://just.systems |
...
| **k9s** | 0.50.8 | Kubernetes CLI To Manage Your Clusters In Style! | https://k9scli.io |
...
| **kotlin** | 2.2.0 | The Kotlin Programming Language | https://kotlinlang.org/ |
...
| **lf** | 35 | Terminal file manager | https://github.com/gokcehan/lf |
...
| **libcurl** | 8.14.1 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.14.1 | Static libraries for libcurl | https://curl.se/ |
...
| **libmosquitto** | 2.0.22 | MQTT library | https://mosquitto.org/ |
...
| **libneon** | 0.34.2 | An HTTP/1.1 and WebDAV client library, with a C interface | https://notroj.github.io/neon/ |
| **libneon-static** | 0.34.2 | Static libraries for libneon | https://notroj.github.io/neon/ |
...
| **libnss** | 3.113.1 | Network Security Services (NSS) | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **libre2** | 2025-06-26b-0 | A regular expression library | https://github.com/google/re2 |
...
| **libunbound** | 1.23.0-1 | A validating, recursive, caching DNS resolver | https://unbound.net/ |
| **libunbound-static** | 1.23.0-1 | Static libraries for libunbound | https://unbound.net/ |
...
| **mautrix-whatsapp** | 0.12.2 | A Matrix-WhatsApp puppeting bridge | https://maunium.net/go/mautrix-whatsapp/ |
| **maven** | 3.9.11 | A Java software project management and comprehension tool | https://maven.apache.org/ |
...
| **minio** | 2025.06.13.11.33.47 | Multi-Cloud Object Storage | https://min.io/ |
...
| **mosquitto** | 2.0.22 | MQTT version 3.1/3.1.1 compatible message broker and clients | https://mosquitto.org/ |
...
| **mu** | 1.12.11 | Maildir indexer/searcher and Emacs client (mu4e) | https://www.djcbsoftware.nl/code/mu/ |
...
| **nss-utils** | 3.113.1 | Tools for NSS | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **oh-my-posh** | 26.15.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **openjdk-17** | 17.0.16 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-17-source** | 17.0.16 | Source files for openjdk-17 | https://openjdk.java.net |
| **openjdk-17-x** | 17.0.16 | Portion of openjdk-17 requiring X11 functionality | https://openjdk.java.net |
| **openjdk-21** | 21.0.7-3 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-21-source** | 21.0.7-3 | Source files for openjdk-21 | https://openjdk.java.net |
| **openjdk-21-x** | 21.0.7-3 | Portion of openjdk-21 requiring X11 functionality | https://openjdk.java.net |
...
| **oxc-language-server** | 1.6.0 | Oxc JavaScript linter language server | https://oxc.rs/ |
| **oxlint** | 1.6.0 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **plantuml** | 1.2025.4 | Draws UML diagrams, using a simple and human readable text description | https://plantuml.com/ |
...
| **pocketbase** | 0.28.4 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **python-ruff** | 0.12.3 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **pyunbound** | 1.23.0-1 | Python bindings for Unbound | https://unbound.net/ |
...
| **railway-cli** | 4.5.4 | This is the command line interface for Railway | https://railway.app |
...
| **ruff** | 0.12.3 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **scala** | 3.7.1 | Scala 3 compiler and standard library. | https://www.scala-lang.org |
...
| **seafile-client** | 9.0.14 | Seafile is a file syncing and sharing software with file encryption and group sharing | https://seafile.com |
| **seafile-client-static** | 9.0.14 | Static libraries for seafile-client | https://seafile.com |
| **seanime** | 2.8.5 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **storj-uplink** | 1.130.8 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **uv** | 0.7.21 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vulkan-headers** | 1.4.322 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-utility-libraries** | 1.4.322 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
...
| **wakatime-cli** | 1.118.0 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **weechat** | 4.6.3 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.6.3 | WeeChat Lua Plugin | https://weechat.org/ |
| **weechat-perl-plugin** | 4.6.3 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.6.3 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.6.3 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **xmake** | 3.0.0 | A cross-platform build utility based on Lua | https://xmake.io/ |
...
| **yosys** | 0.55 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
...
| **zrok** | 1.0.6 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
