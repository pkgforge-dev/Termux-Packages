...
| **cargo-binstall** | 1.21.0 | Tool to fetch and install precompiled musl-based static binaries from the Rust ecosystem | https://github.com/cargo-bins/cargo-binstall |
...
| **cec-client** | 8.0.0 | Client applications for libCEC | https://libcec.pulse-eight.com/ |
...
| **command-not-found** | 3.5.0-3 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **deno** | 1:2.9.3 | A modern runtime for JavaScript and TypeScript | https://deno.land/ |
...
| **jackett** | 0.24.2233 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **lesspipe** | 2.27 | An input filter for the pager less | https://lesspipe.org/ |
...
| **libcec** | 8.0.0 | Provides support for Pulse-Eight's USB-CEC adapter and other CEC capable hardware | https://libcec.pulse-eight.com/ |
| **libcec-static** | 8.0.0 | Static libraries for libcec | https://libcec.pulse-eight.com/ |
...
| **libical** | 4.0.3 | Libical is an Open Source implementation of the iCalendar protocols and protocol data units | https://libical.github.io/libical/ |
...
| **librusty-v8** | 1:2.9.3 | High quality Rust bindings to V8's C++ API | https://deno.land/ |
...
| **lux-cli** | 0.39.2 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **neocmakelsp** | 0.10.4 | a cmake lsp based on tower-lsp and treesitter | https://neocmakelsp.github.io/ |
...
| **neovim-nightly** | 0.13.0~dev-1103+ge4137a7324-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **onnxruntime** | 1.27.1 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **prowlarr** | 2.4.0.5397-3 | An indexer manager/proxy built on the popular arr stack (server) | https://prowlarr.com |
...
| **pulseaudio** | 17.0-2 | A featureful, general-purpose sound server | https://www.freedesktop.org/wiki/Software/PulseAudio |
| **pulseaudio-glib** | 17.0-2 | PulseAudio GLIB mainloop component | https://www.freedesktop.org/wiki/Software/PulseAudio |
...
| **python-onnxruntime** | 1.27.1 | Cross-platform, high performance ML inferencing and training accelerator (Python bindings) | https://onnxruntime.ai/ |
...
| **recoll** | 1.44.0-1 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.44.0-1 | Python interface for Recoll | https://www.recoll.org/ |
...
| **sqlite** | 3.53.3 | Command line shell for SQLite | https://www.sqlite.org |
...
| **turbopack** | 16.2.11 | Rust-based incremental compilation engine and bundler for Next.js | https://nextjs.org/ |
