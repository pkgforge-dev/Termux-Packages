...
| **awscli** | 2.36.17 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **cec-client** | 8.1.4 | Client applications for libCEC | https://libcec.pulse-eight.com/ |
...
| **discordo** | 2026.07.23+g54a64318 | A lightweight, secure, and feature-rich Discord terminal client | https://github.com/ayn2op/discordo |
...
| **emmylua-ls** | 0.24.0 | Emmy Lua Language Server coded in Rust | https://github.com/EmmyLuaLs/emmylua-analyzer-rust |
...
| **fastfetch** | 2.66.0 | A maintained, feature-rich and performance oriented, neofetch like system information tool | https://github.com/fastfetch-cli/fastfetch |
...
| **fontconfig-static** | 2.18.2 | Static libraries for fontconfig | https://www.freedesktop.org/wiki/Software/fontconfig/ |
| **fontconfig-utils** | 2.18.2 | Fontconfig binaries | https://www.freedesktop.org/wiki/Software/fontconfig/ |
...
| **fresh-editor** | 0.4.6 | Text editor for your terminal: easy, powerful and fast | https://getfresh.dev/ |
...
| **gradle** | 1:9.6.1 | Powerful build system for the JVM | https://gradle.org/ |
...
| **jellyfin-ffmpeg** | 10.11.11-1 | FFmpeg for Jellyfin with custom extensions and enhancements | https://jellyfin.org |
| **jellyfin-server** | 10.11.11-1 | A free media system for organizing and streaming media (server) | https://jellyfin.org |
| **jfrog-cli** | 2.118.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **libblosc2** | 3.3.1 | A blocking, shuffling and loss-less compression library | https://www.blosc.org |
...
| **libcec** | 8.1.4 | Provides support for Pulse-Eight's USB-CEC adapter and other CEC capable hardware | https://libcec.pulse-eight.com/ |
| **libcec-static** | 8.1.4 | Static libraries for libcec | https://libcec.pulse-eight.com/ |
...
| **libftxui** | 7.0.2 | A simple C++ library for terminal based user interface | https://github.com/ArthurSonzogni/FTXUI |
...
| **libheif** | 1.23.1 | HEIF (HEIC/AVIF) image encoding and decoding library | https://github.com/strukturag/libheif |
| **libheif-progs** | 1.23.1 | Programs for manipulating HEIF (HEIC/AVIF) image files | https://github.com/strukturag/libheif |
| **libhiredis** | 1.4.0 | Hiredis is a minimalistic C client library for the Redis database | https://redis.com/lp/hiredis |
...
| **libmicrohttpd** | 1.0.9 | A small C library that is supposed to make it easy to run an HTTP server as part of another application | http://www.gnu.org/software/libmicrohttpd/ |
| **libmicrohttpd-static** | 1.0.9 | Static libraries for libmicrohttpd | http://www.gnu.org/software/libmicrohttpd/ |
...
| **libpluto** | 0.13.0 | Shared library for the Pluto interpreter | https://plutolang.github.io/ |
| **libpluto-static** | 0.13.0 | Static libraries for libpluto | https://plutolang.github.io/ |
...
| **lux-cli** | 0.40.1 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **neovim-nightly** | 0.13.0~dev-1244+g54373e2453-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **nmap** | 7.99-1 | Utility for network discovery and security auditing | https://nmap.org/ |
...
| **openlist** | 4.2.4 | A file list program that supports multiple storage | https://oplist.org/ |
...
| **openxr** | 1.1.61 | Open standard that provides a common set of APIs for developing XR applications | https://www.khronos.org/openxr/ |
...
| **pango** | 1.58.0 | Library for laying out and rendering text | https://www.gtk.org/docs/architecture/pango |
...
| **plutolang** | 0.13.0 | A superset of Lua 5.4 with a focus on general-purpose programming. | https://plutolang.github.io/ |
...
| **povray** | 3.8.0-beta.2-19 | The Persistence of Vision Raytracer | https://www.povray.org/ |
| **povray-data** | 3.8.0-beta.2-19 | Platform-independent data for povray | https://www.povray.org/ |
...
| **pybind11** | 3.0.4-1 | A lightweight header-only library that exposes C++ types in Python and vice versa | https://pybind11.readthedocs.io/ |
| **pycairo** | 1.29.0-2 | Python bindings for the cairo graphics library | https://www.cairographics.org/pycairo/ |
...
| **redis** | 1:8.8.1 | In-memory data structure store used as a database, cache and message broker | https://redis.io/ |
...
| **ruff** | 0.16.1 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **sftpgo** | 2.7.5 | Full-featured and highly configurable SFTP, HTTP/S, FTP/S and WebDAV server | https://sftpgo.com/ |
...
| **soju** | 0.10.1-1 | A user-friendly IRC bouncer | https://codeberg.org/emersion/soju |
...
| **storj-uplink** | 1.161.5 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **swi-prolog** | 10.1.12 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **ty** | 0.0.68 | An extremely fast Python type checker and language server, written in Rust | https://github.com/astral-sh/ty |
...
| **uv** | 0.12.2 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vlc** | 3.0.23-4 | A popular libre and open source media player and multimedia engine | https://www.videolan.org/ |
| **vlc-static** | 3.0.23-4 | Static libraries for vlc | https://www.videolan.org/ |
...
| **vulkan-headers** | 1.4.358 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.358 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.358 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.358 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
...
| **wakatime-cli** | 2.23.0 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **zola** | 0.23.1 | A fast static site generator in a single binary with everything built-in. | https://github.com/getzola/zola |
