...
| **atuin** | 18.11.0 | Magical shell history | https://atuin.sh/ |
...
| **command-not-found** | 3.2-15 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **dnscontrol** | 4.33.0 | Infrastructure as code for DNS! | https://github.com/StackExchange/dnscontrol |
...
| **emmylua-ls** | 0.20.0 | Emmy Lua Language Server coded in Rust | https://github.com/EmmyLuaLs/emmylua-analyzer-rust |
| **emscripten** | 5.0.0 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 5.0.0 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 5.0.0 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 5.0.0 | Emscripten third party test suite files | https://emscripten.org |
...
| **exiftool** | 13.48 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **fish** | 4.4.0 | The user-friendly command line shell | https://fishshell.com/ |
...
| **forgejo** | 14.0.2 | Forgejo is a self-hosted lightweight software forge. | https://forgejo.org/ |
...
| **gdk-pixbuf** | 2.44.5 | Library for image loading and manipulation | https://wiki.gnome.org/Projects/GdkPixbuf |
...
| **gitoxide** | 0.50.0 | Rust implementation of Git | https://github.com/Byron/gitoxide |
...
| **glab-cli** | 1.82.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **graphviz** | 14.1.2 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 14.1.2 | Static libraries for graphviz | https://www.graphviz.org/ |
...
| **haproxy** | 3.3.2 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
...
| **jackett** | 0.24.1008 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **libblosc2** | 2.23.0 | A blocking, shuffling and loss-less compression library | https://www.blosc.org |
| **libblosc2-static** | 2.23.0 | Static libraries for libblosc2 | https://www.blosc.org |
...
| **libp11** | 0.4.17 | PKCS#11 wrapper library | https://github.com/OpenSC/libp11 |
...
| **marksman** | 2026.01.28 | LSP language server for editing Markdown files | https://github.com/artempyanykh/marksman |
...
| **mdds** | 3.2.0-1 | A collection of multi-dimensional data structures and indexing algorithms | https://gitlab.com/mdds/mdds |
...
| **mediamtx** | 1.16.0 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
| **megacmd** | 2.4.0 | Provides non UI access to MEGA services | https://mega.io/ |
...
| **mesa** | 25.3.4 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 25.3.4 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-opencl-icd-rusticl** | 25.3.4 | Mesa's Rusticl OpenCL ICD | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 25.3.4 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **navidrome** | 0.59.0-1 | Modern Music Server and Streamer compatible with Subsonic/Airsonic | https://www.navidrome.org/ |
...
| **neocmakelsp** | 0.10.0 | a cmake lsp based on tower-lsp and treesitter | https://neocmakelsp.github.io/ |
...
| **neovim** | 0.11.6 | Ambitious Vim-fork focused on extensibility and agility (nvim) | https://neovim.io/ |
| **neovim-nightly** | 0.12.0~dev-2112+gb6befc7b03-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **oma** | 1.23.4 | oma is an attempt at reworking APT's interface | https://aosc.io/oma |
...
| **onnxruntime** | 1.23.2-1 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **osslsigncode** | 2.12 | OpenSSL based Authenticode signing for PE/MSI/Java CAB files | https://github.com/mtrojnar/osslsigncode |
...
| **oxfmt** | 1.43.0 | Oxc JavaScript formatter | https://oxc.rs/ |
| **oxlint** | 1.43.0 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **pyrefly** | 0.50.0 | A fast type checker and language server for Python | https://github.com/facebook/pyrefly.git |
...
| **python-onnxruntime** | 1.23.2-1 | Cross-platform, high performance ML inferencing and training accelerator (Python bindings) | https://onnxruntime.ai/ |
...
| **python-ruff** | 0.14.14 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **python-yt-dlp** | 2026.01.31 | A youtube-dl fork with additional features and fixes | https://github.com/yt-dlp/yt-dlp |
...
| **railway-cli** | 4.27.6 | This is the command line interface for Railway | https://railway.app |
...
| **rizin** | 0.8.2 | UNIX-like reverse engineering framework and command-line toolset. | https://rizin.re |
...
| **ruff** | 0.14.14 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust** | 1.93.0 | Systems programming language focused on safety, speed and concurrency | https://www.rust-lang.org/ |
| **rust-analyzer** | 20260202 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **rust-docs** | 1.93.0 | Rust documentation | https://www.rust-lang.org/ |
| **rust-src** | 1.93.0 | Rust source code files | https://www.rust-lang.org/ |
| **rust-std-aarch64-linux-android** | 1.93.0 | Rust std for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.93.0 | Rust std for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.93.0 | Rust std for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.93.0 | Rust std for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip1** | 1.93.0 | Rust std for target wasm32-wasip1 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip2** | 1.93.0 | Rust std for target wasm32-wasip2 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip3** | 1.93.0 | Rust std for target wasm32-wasip3 | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.93.0 | Rust std for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.93.0 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.93.0 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **seanime** | 3.4.3 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **storj-uplink** | 1.146.8 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **syncthing** | 2.0.14 | Decentralized file synchronization | https://syncthing.net/ |
...
| **teleport-tsh** | 18.6.6 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **topgrade** | 16.9.0 | Upgrade all the things | https://github.com/topgrade-rs/topgrade/ |
| **tor** | 0.4.8.22 | The Onion Router anonymizing overlay network | https://www.torproject.org |
...
| **tree-sitter-c** | 0.24.1-5 | C grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-c |
| **tree-sitter-css** | 0.25.0 | CSS grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-css |
| **tree-sitter-go** | 0.25.0 | Golang grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-go |
| **tree-sitter-html** | 0.23.2 | HTML grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-html |
| **tree-sitter-java** | 0.23.5 | Java grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-java |
| **tree-sitter-javascript** | 0.25.0 | JavaScript grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-javascript |
| **tree-sitter-json** | 0.24.8 | JSON grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-json |
| **tree-sitter-latex** | 0.6.0 | LaTeX grammar for tree-sitter | https://github.com/latex-lsp/tree-sitter-latex |
| **tree-sitter-lua** | 0.4.1 | Lua grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-lua |
| **tree-sitter-markdown** | 0.5.2-1 | Markdown grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-markdown |
| **tree-sitter-parsers** | 0.1.0 | A metapackage that provides commonly used treesitter parsers | https://github.com/termux/termux-packages |
...
| **tree-sitter-vim** | 0.8.0 | Vimscript grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-vim |
...
| **tree-sitter-vimdoc** | 4.1.0-1 | Tree-sitter parser for Vim help files | https://github.com/neovim/tree-sitter-vimdoc |
| **tree-sitter-vimdoc-static** | 4.1.0 | Static libraries for tree-sitter-vimdoc | https://github.com/neovim/tree-sitter-vimdoc |
| **tree-sitter-xml** | 0.7.0 | XML grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-xml |
| **tree-sitter-yaml** | 0.7.2 | YAML grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-yaml |
...
| **vgmstream** | 2083 | A library for playback of various streamed audio formats used in video games | https://github.com/vgmstream/vgmstream |
...
| **vulkan-headers** | 1.4.342 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-utility-libraries** | 1.4.342 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
| **vulkan-validation-layers** | 1.4.342 | Vulkan Validation Layers | https://github.com/KhronosGroup/Vulkan-ValidationLayers |
