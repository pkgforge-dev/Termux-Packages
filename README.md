...
| **borgbackup** | 1.4.3-2 | Deduplicating and compressing backup program | https://www.borgbackup.org/ |
...
| **cmake** | 4.2.3-1 | Family of tools designed to build, test and package software | https://cmake.org/ |
| **cmake-curses-gui** | 4.2.3-1 | Curses based user interface for CMake (ccmake) | https://cmake.org/ |
...
| **cookcli** | 0.24.0 | A suite of tools to create shopping lists and maintain food recipes | https://cooklang.org |
...
| **cppcheck** | 2.20.0 | tool for static C/C++ code analysis | https://github.com/danmar/cppcheck |
...
| **erlang** | 28.4 | General-purpose concurrent functional programming language | https://www.erlang.org/ |
| **erlang-doc** | 28.4 | Erlang HTML documentation | https://www.erlang.org/ |
...
| **exiftool** | 13.52 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **fselect** | 0.9.3 | Find files with SQL-like queries | https://fselect.rocks/ |
...
| **gdb** | 16.3-2 | The standard GNU Debugger that runs on many Unix-like systems and works for many programming languages | https://www.gnu.org/software/gdb/ |
...
| **gdbserver** | 16.3-2 | The gdbserver program | https://www.gnu.org/software/gdb/ |
...
| **geth** | 1.17.1 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.17.1 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **glab-cli** | 1.88.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **gradle** | 1:9.4.0 | Powerful build system for the JVM | https://gradle.org/ |
...
| **harfbuzz** | 13.0.0 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 13.0.0 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 13.0.0 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **jfrog-cli** | 2.94.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **libneon** | 0.37.0 | An HTTP/1.1 and WebDAV client library, with a C interface | https://notroj.github.io/neon/ |
| **libneon-static** | 0.37.0 | Static libraries for libneon | https://notroj.github.io/neon/ |
...
| **libplacebo** | 7.360.0-2 | Reusable library for GPU-accelerated video/image rendering | http://libplacebo.org/ |
...
| **libtorrent** | 0.16.7 | Libtorrent BitTorrent library | https://github.com/rakshasa/rtorrent/wiki |
...
| **libtorrent-static** | 0.16.7 | Static libraries for libtorrent | https://github.com/rakshasa/rtorrent/wiki |
...
| **libwebsockets** | 4.5.3 | Lightweight C websockets library | https://libwebsockets.org |
...
| **mediamtx** | 1.16.3 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **oh-my-posh** | 29.7.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **oma** | 1.24.4 | oma is an attempt at reworking APT's interface | https://aosc.io/oma |
...
| **onnxruntime** | 1.24.2-1 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **orbiton** | 2.73.0 | Small, fast and limited text editor | https://roboticoverlords.org/orbiton/ |
...
| **oxfmt** | 1.51.0 | Oxc JavaScript formatter | https://oxc.rs/ |
| **oxlint** | 1.51.0 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **pyrefly** | 0.55.0 | A fast type checker and language server for Python | https://github.com/facebook/pyrefly.git |
...
| **python** | 3.13.12-2 | Python 3 programming language intended to enable clear programs | https://python.org/ |
...
| **python-ensurepip-wheels** | 3.13.12-2 | Wheels for Python ensurepip | https://python.org/ |
...
| **python-grpcio** | 1.78.1-1 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **python-sabyenc3** | 9.3.2-1 | C implementations of functions for use within SABnzbd | https://github.com/sabnzbd/sabctools |
| **python-skia-pathops** | 0.9.2-1 | Python bindings for the Skia library's Path Ops | https://github.com/fonttools/skia-pathops |
| **python-static** | 3.13.12-2 | Static libraries for python | https://python.org/ |
| **python-tflite-runtime** | 2.20.0-2 | TensorFlow Lite Python bindings | https://www.tensorflow.org/lite |
| **python-tkinter** | 3.13.12-2 | Tkinter support for Python 3 | https://python.org/ |
| **python-tldp** | 0.7.5-7 | Tools for publishing from TLDP sources | https://github.com/tLDP/python-tldp |
| **python-torch** | 2.10.0-1 | Tensors and Dynamic neural networks in Python | https://pytorch.org/ |
| **python-torch-static** | 2.10.0-1 | Static libraries for python-torch | https://pytorch.org/ |
...
| **python-torchvision** | 0.25.0-1 | Datasets, Transforms and Models specific to Computer Vision | https://github.com/pytorch/vision |
...
| **python-yt-dlp** | 2026.03.03 | A youtube-dl fork with additional features and fixes | https://github.com/yt-dlp/yt-dlp |
...
| **recoll** | 1.43.13-2 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.43.13-2 | Python interface for Recoll | https://www.recoll.org/ |
...
| **rtorrent** | 0.16.7 | Ncurses BitTorrent client based on libTorrent | https://rakshasa.github.io/rtorrent/ |
...
| **ruff** | 0.15.4-1 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust-analyzer** | 20260302 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **storj-uplink** | 1.148.4 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **syncthing** | 2.0.15 | Decentralized file synchronization | https://syncthing.net/ |
...
| **txikijs** | 1:26.3.0 | A small and powerful JavaScript runtime | https://github.com/saghul/txiki.js |
...
| **usql** | 0.21.1 | A universal command-line interface for SQL databases | https://github.com/xo/usql |
...
| **uv** | 0.9.15-1 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vim** | 9.2.0100 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **vtm** | 2026.02.28 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **wireproxy** | 1.1.1 | Wireguard client that exposes itself as a socks5 proxy | https://github.com/pufferffish/wireproxy |
...
| **xxd** | 9.2.0100 | Hexdump utility from vim | https://www.vim.org |
...
| **yosys** | 0.63 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
...
| **yt-dlp-ejs** | 0.5.0-2 | External JavaScript for yt-dlp supporting many runtimes | https://github.com/yt-dlp/ejs |
