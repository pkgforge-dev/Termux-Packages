...
| **jackett** | 0.22.1908 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **uv** | 0.7.4 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
