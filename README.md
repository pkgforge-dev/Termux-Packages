...
| **awscli** | 2.33.25-1 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **binutils** | 2.46.0-1 | A GNU collection of binary utilities | https://www.gnu.org/software/binutils/ |
| **binutils-bin** | 2.46.0-1 | Collection of binary tools, the main ones being ld, the GNU linker, and as, the GNU assembler | https://www.gnu.org/software/binutils/ |
| **binutils-cross** | 2.46.0-1 | GNU Binutils for cross build on the host (NOT for Termux) | https://www.gnu.org/software/binutils/ |
...
| **crawl** | 0.34.0 | Roguelike adventure through dungeons filled with dangerous monsters | https://crawl.develz.org/ |
...
| **cups-pdf** | 3.0.1-2 | CUPS PDF backend | https://www.cups-pdf.de/ |
...
| **dnsutils** | 9.20.19 | Clients provided with BIND | https://www.isc.org/bind/ |
...
| **exiftool** | 13.51 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **fish** | 4.5.0 | The user-friendly command line shell | https://fishshell.com/ |
...
| **fresh-editor** | 0.2.5 | Text editor for your terminal: easy, powerful and fast | https://getfresh.dev/ |
...
| **fzf** | 0.68.0 | Command-line fuzzy finder | https://junegunn.github.io/fzf/ |
...
| **gh** | 2.87.2 | GitHub’s official command line tool | https://cli.github.com/ |
| **ghc** | 9.12.2-2 | The Glasgow Haskell Compiler | https://www.haskell.org/ghc/ |
| **ghostscript** | 10.06.0 | Interpreter for the PostScript language and for PDF | https://www.ghostscript.com/ |
...
| **haproxy** | 3.3.4 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
...
| **hugo** | 0.156.0 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **imagemagick** | 7.1.2.13-1 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.2.13-1 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **jackett** | 0.24.1127 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jfrog-cli** | 2.92.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **libcap-ng** | 2:0.9.1 | Library making programming with POSIX capabilities easier than traditional libcap | https://people.redhat.com/sgrubb/libcap-ng/ |
| **libcap-ng-static** | 2:0.9.1 | Static libraries for libcap-ng | https://people.redhat.com/sgrubb/libcap-ng/ |
...
| **libnss** | 3.121 | Network Security Services (NSS) | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **libspectre** | 0.2.12-2 | A small library for rendering Postscript documents | https://www.freedesktop.org/wiki/Software/libspectre/ |
| **libspectre-static** | 0.2.12-2 | Static libraries for libspectre | https://www.freedesktop.org/wiki/Software/libspectre/ |
...
| **lilypond** | 2.24.4-4 | A music engraving program | https://lilypond.org/ |
...
| **mautrix-whatsapp** | 0.2602.0 | A Matrix-WhatsApp puppeting bridge | https://maunium.net/go/mautrix-whatsapp/ |
...
| **miniserve** | 0.33.0 | Tool to serve files and dirs over HTTP | https://github.com/svenstaro/miniserve |
...
| **neovim-nightly** | 0.12.0~dev-2374+g94c21c22dc-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **npm** | 11.10.1 | The package manager for JavaScript | https://docs.npmjs.com/cli/ |
...
| **nss-utils** | 3.121 | Tools for NSS | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **oh-my-posh** | 29.4.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **onnxruntime** | 1.24.2 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **orbiton** | 2.72.1 | Small, fast and limited text editor | https://roboticoverlords.org/orbiton/ |
...
| **oxfmt** | 1.49.0 | Oxc JavaScript formatter | https://oxc.rs/ |
| **oxlint** | 1.49.0 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **pocketbase** | 0.36.4 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **python-greenlet** | 3.3.2 | Lightweight coroutines for in-process concurrent programming | https://github.com/python-greenlet/greenlet |
...
| **python-onnxruntime** | 1.24.2 | Cross-platform, high performance ML inferencing and training accelerator (Python bindings) | https://onnxruntime.ai/ |
...
| **python-skia-pathops** | 0.9.2 | Python bindings for the Skia library's Path Ops | https://github.com/fonttools/skia-pathops |
...
| **railway-cli** | 4.30.3 | This is the command line interface for Railway | https://railway.app |
...
| **rclone** | 1.73.1 | rsync for cloud storage | https://rclone.org/ |
...
| **remind** | 1:06.02.04 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **rust-analyzer** | 20260216 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **taglib** | 2.2 | A Library for reading and editing the meta-data of several popular audio formats. | http://taglib.github.io/ |
...
| **tea** | 0.12.0 | The official CLI for Gitea | https://gitea.com/gitea/tea |
...
| **teleport-tsh** | 18.7.0 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **vim** | 9.2.0018 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **vtm** | 2026.02.20 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **vulkan-headers** | 1.4.344 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.344 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.344 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.344 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
...
| **xxd** | 9.2.0018 | Hexdump utility from vim | https://www.vim.org |
