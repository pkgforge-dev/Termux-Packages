...
| **asymptote** | 3.06 | A powerful descriptive vector graphics language for technical drawing | https://asymptote.sourceforge.io/ |
...
| **awscli** | 2.33.17 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **ccache** | 4.12.3 | Compiler cache for fast recompilation of C/C++ code | https://ccache.samba.org |
...
| **cloudflared** | 2026.2.0 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **command-not-found** | 3.2-16 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **exiftool** | 13.50 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **ffmpeg** | 8.0.1-2 | Tools and libraries to manipulate a wide range of multimedia formats and protocols | https://ffmpeg.org |
...
| **flatbuffers** | 25.12.19-2026-02-06-03fffb2-0 | Memory Efficient Serialization Library | https://github.com/google/flatbuffers |
| **flatbuffers-static** | 25.12.19-2026-02-06-03fffb2-0 | Static libraries for flatbuffers | https://github.com/google/flatbuffers |
...
| **frp** | 0.67.0 | A fast reverse proxy to expose a local server behind a NAT or firewall to the internet | https://github.com/fatedier/frp |
...
| **jackett** | 0.24.1008-1 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **keybase** | 6.5.2 | Key directory that maps social media identities to encryption keys | https://keybase.io |
...
| **libgrpc** | 1.78.0 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **libmosquitto** | 2.1.1 | MQTT library | https://mosquitto.org/ |
...
| **libraqm** | 0.10.4 | Raqm is a small library that encapsulates the logic for complex text layout and provides a convenient API | https://github.com/HOST-Oman/libraqm |
...
| **mediamtx** | 1.16.1 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **mesa** | 25.3.5 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 25.3.5 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-opencl-icd-rusticl** | 25.3.5 | Mesa's Rusticl OpenCL ICD | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 25.3.5 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **mosquitto** | 2.1.1 | MQTT version 3.1/3.1.1 compatible message broker and clients | https://mosquitto.org/ |
...
| **navidrome** | 0.60.2 | Modern Music Server and Streamer compatible with Subsonic/Airsonic | https://www.navidrome.org/ |
...
| **neovim-nightly** | 0.12.0~dev-2200+g396edf1e46-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **npm** | 11.9.0 | The package manager for JavaScript | https://docs.npmjs.com/cli/ |
...
| **oma** | 1.23.5 | oma is an attempt at reworking APT's interface | https://aosc.io/oma |
...
| **onnxruntime** | 1.24.1 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **python-grpcio** | 1.78.0 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **python-yt-dlp** | 2026.02.04 | A youtube-dl fork with additional features and fixes | https://github.com/yt-dlp/yt-dlp |
...
| **remind** | 1:06.02.03 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **svt-av1** | 4.0.1 | Scalable Video Technology for AV1 (SVT-AV1 Encoder and Decoder) | https://gitlab.com/AOMediaCodec/SVT-AV1 |
...
| **vtm** | 2026.02.06 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **vulkan-headers** | 1.4.343 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.343 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.342 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.343 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
