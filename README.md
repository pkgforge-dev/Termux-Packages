...
| **awscli** | 2.36.15 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **biome2** | 2.5.6 | A toolchain for web projects, aimed to provide functionalities to maintain them. Biome offers formatter and linter, usable via CLI and LSP | https://biomejs.dev/ |
...
| **elixir** | 1.20.2 | Elixir is a dynamic, functional language designed for building scalable and maintainable applications | https://elixir-lang.org/ |
...
| **erlang** | 29.0.4 | General-purpose concurrent functional programming language | https://www.erlang.org/ |
| **erlang-doc** | 29.0.4 | Erlang HTML documentation | https://www.erlang.org/ |
...
| **flyctl** | 0.4.78 | Command line tools for fly.io services | https://fly.io |
...
| **ghc** | 9.12.2-4 | The Glasgow Haskell Compiler | https://www.haskell.org/ghc/ |
...
| **glab-cli** | 1.111.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **go-musicfox** | 5.0.1 | A netease music player in terminal. | https://github.com/go-musicfox/go-musicfox |
...
| **gst-plugins-ugly** | 1.28.5 | GStreamer Ugly Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-python** | 1.28.5 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
| **gstreamer** | 1.28.5 | Open source multimedia framework | https://gstreamer.freedesktop.org/ |
...
| **lazygit** | 0.63.1 | Simple terminal UI for git commands | https://github.com/jesseduffield/lazygit |
...
| **libunbound** | 1.25.2 | A validating, recursive, caching DNS resolver | https://unbound.net/ |
| **libunbound-static** | 1.25.2 | Static libraries for libunbound | https://unbound.net/ |
...
| **lux-cli** | 0.40.0 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **mediamtx** | 1.19.3 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **mise** | 2026.8.1 | dev tools, env vars, task runner | https://mise.jdx.dev/ |
...
| **neovim-nightly** | 0.13.0~dev-1212+g8d2b50c0ce-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **oh-my-posh** | 30.5.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **pyunbound** | 1.25.2 | Python bindings for Unbound | https://unbound.net/ |
...
| **storj-uplink** | 1.161.2 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **stunnel** | 5.79 | Socket wrapper which can provide TLS support to ordinary applications | https://www.stunnel.org/ |
| **stunnel-static** | 5.79 | Static libraries for stunnel | https://www.stunnel.org/ |
...
| **unbound** | 1.25.2 | Unbound command-line tools | https://unbound.net/ |
...
| **vulkan-tools** | 1.4.357 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
...
| **yosys** | 0.67 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
