...
| **aom-tools** | 3.13.2 | Command-line tools using AOMedia library | https://aomedia.org/ |
...
| **atuin** | 18.13.3 | Magical shell history | https://atuin.sh/ |
...
| **broot** | 1.56.1 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **cmake** | 4.3.0 | Family of tools designed to build, test and package software | https://cmake.org/ |
| **cmake-curses-gui** | 4.3.0 | Curses based user interface for CMake (ccmake) | https://cmake.org/ |
...
| **command-not-found** | 3.4.1-2 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **dasel** | 3.4.0 | Select, put and delete data from JSON, TOML, YAML, XML and CSV files with a single utility | https://github.com/TomWright/dasel |
...
| **diff-so-fancy** | 1.4.6 | Good-lookin' diffs. Actually... nah... The best-lookin' diffs | https://github.com/so-fancy/diff-so-fancy |
...
| **emscripten** | 5.0.3 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 5.0.3 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 5.0.3 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 5.0.3 | Emscripten third party test suite files | https://emscripten.org |
...
| **exiftool** | 13.53 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **fresh-editor** | 0.2.17 | Text editor for your terminal: easy, powerful and fast | https://getfresh.dev/ |
...
| **gdal** | 3.12.3 | A translator library for raster and vector geospatial data formats | https://gdal.org |
...
| **gdu** | 5.34.2 | Fast disk usage analyzer with console interface written in Go | https://github.com/dundee/gdu |
...
| **git-delta** | 0.19.1 | A syntax-highlighter for git and diff output | https://dandavison.github.io/delta/ |
...
| **greed** | 4.4 | Game where you try to eat as much as possible of the board before munching yourself into a corner | http://www.catb.org/~esr/greed/ |
...
| **harfbuzz** | 13.2.1 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 13.2.1 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 13.2.1 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **hcloud** | 1.62.0 | Hetzner Cloud command line client | https://github.com/hetznercloud/cli |
...
| **hugo** | 0.158.0 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **imagemagick** | 7.1.2.17 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.2.17 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **jackett** | 0.24.1412 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **just** | 1.47.1 | A handy way to save and run project-specific commands | https://just.systems |
...
| **libaom** | 3.13.2 | AV1 Video Codec Library | https://aomedia.org/ |
| **libaom-static** | 3.13.2 | Static libraries for libaom | https://aomedia.org/ |
...
| **mediamtx** | 1.17.0 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **mesa** | 26.0.3 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 26.0.3 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-opencl-icd-rusticl** | 26.0.3 | Mesa's Rusticl OpenCL ICD | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 26.0.3 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **mympd** | 25.0.0 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **neovim-nightly** | 0.12.0~dev-2664+g256811a617-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **npm** | 11.12.0 | The package manager for JavaScript | https://docs.npmjs.com/cli/ |
...
| **oma** | 1.25.0 | oma is an attempt at reworking APT's interface | https://aosc.io/oma |
...
| **oxfmt** | 1.56.0 | Oxc JavaScript formatter | https://oxc.rs/ |
| **oxlint** | 1.56.0 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **pocketbase** | 0.36.7 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **railway-cli** | 4.33.0 | This is the command line interface for Railway | https://railway.app |
...
| **rust-analyzer** | 20260316 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **seafile-client** | 9.0.17 | Seafile is a file syncing and sharing software with file encryption and group sharing | https://seafile.com |
| **seafile-client-static** | 9.0.17 | Static libraries for seafile-client | https://seafile.com |
...
| **simdjson** | 4.4.2 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
...
| **step-cli** | 0.30.1 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **turbo** | 2.8.20 | High-performance build system for JS/TS | https://turbo.build/ |
...
| **txikijs** | 1:26.3.1 | A small and powerful JavaScript runtime | https://github.com/saghul/txiki.js |
...
| **udocker** | 1.3.17-3 | A basic user tool to execute simple docker containers in batch or interactive systems without root privileges. | https://indigo-dc.github.io/udocker |
...
| **uv** | 0.10.12 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vim** | 9.2.0200 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **vtm** | 2026.03.21 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
...
| **vulkan-headers** | 1.4.347 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **wakatime-cli** | 1.139.4 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **xxd** | 9.2.0200 | Hexdump utility from vim | https://www.vim.org |
