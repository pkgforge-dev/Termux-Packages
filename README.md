...
| **go-musicfox** | 4.6.4 | A netease music player in terminal. | https://github.com/go-musicfox/go-musicfox |
...
| **oxc-language-server** | 1.11.0 | Oxc JavaScript linter language server | https://oxc.rs/ |
| **oxlint** | 1.11.0 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **uv** | 0.8.6 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **wakatime-cli** | 1.130.1 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **yosys** | 0.56 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
