...
| **anewer** | 0.2.1 | Append lines from stdin to a file if these lines do not present in that file (aHash-based uniq) | https://github.com/ysf/anewer |
...
| **awscli** | 2.36.29 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **bear** | 4.2.1 | Bear is a tool that generates a compilation database for clang tooling. | https://github.com/rizsotto/Bear |
...
| **binaryen** | 132-1 | Binaryen is a compiler and toolchain infrastructure library for WebAssembly | https://github.com/WebAssembly/binaryen |
...
| **biome2** | 2.5.10 | A toolchain for web projects, aimed to provide functionalities to maintain them. Biome offers formatter and linter, usable via CLI and LSP | https://biomejs.dev/ |
...
| **byobu** | 7.18 | Byobu is a GPLv3 open source text-based window manager and terminal multiplexer | https://www.byobu.org/ |
...
| **cicada** | 1.3.0 | A bash like Unix shell | https://github.com/mitnk/cicada |
...
| **command-not-found** | 3.5.0-7 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **dar** | 2.8.6 | A full featured command-line backup tool, short for Disk ARchive | http://dar.linux.free.fr/ |
...
| **dart** | 3.13.1 | Dart is a general-purpose programming language | https://dart.dev/ |
...
| **dnsutils** | 9.20.27 | Clients provided with BIND | https://www.isc.org/bind/ |
...
| **flyctl** | 0.4.87 | Command line tools for fly.io services | https://fly.io |
...
| **frei0r-plugins** | 3.4.0 | Minimalistic plugin API for video effects | https://www.dyne.org/software/frei0r/ |
| **fresh-editor** | 0.4.10 | Text editor for your terminal: easy, powerful and fast | https://getfresh.dev/ |
...
| **gh** | 2.98.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **glab-cli** | 1.114.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **gum** | 2.0.0 | A tool for creating minimal interactive TUIs for shell scripts | https://github.com/charmbracelet/gum |
...
| **jackett** | 0.24.2413 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **lego** | 5.4.0 | Let's Encrypt/ACME client and library written in Go | https://github.com/go-acme/lego |
...
| **libconfuse** | 3.4 | Small configuration file parser library for C | https://github.com/martinh/libconfuse |
| **libconfuse-static** | 3.4 | Static libraries for libconfuse | https://github.com/martinh/libconfuse |
...
| **libdart** | 6.19.4 | Dynamic Animation and Robotics Toolkit | https://dartsim.github.io/ |
...
| **llama-cpp** | 0.0.0-b10516-0 | LLM inference in C/C++ | https://github.com/ggml-org/llama.cpp |
| **llama-cpp-backend-opencl** | 0.0.0-b10516-0 | OpenCL Backend for LLaMA.cpp | https://github.com/ggml-org/llama.cpp |
| **llama-cpp-backend-vulkan** | 0.0.0-b10516-0 | Vulkan Backend for LLaMA.cpp | https://github.com/ggml-org/llama.cpp |
...
| **luau** | 0.735 | A small, fast, and embeddable programming language based on Lua with a gradual type system. | https://github.com/luau-lang/luau |
...
| **mediamtx** | 1.20.1 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **mise** | 2026.8.10 | dev tools, env vars, task runner | https://mise.jdx.dev/ |
...
| **moor** | 2.17.0 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **neovim-nightly** | 0.13.0~dev-1367+g40740f49f8-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **oma** | 1.27.6 | oma is an attempt at reworking APT's interface | https://aosc.io/oma |
...
| **proot** | 5.1.107.91 | Emulate chroot, bind mount and binfmt_misc for non-root users | https://proot-me.github.io/ |
| **proot-distro** | 5.7.0 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **proton-pass-cli** | 2.3.2-1 | Proton Pass Command Line Interface (CLI) | https://protonpass.github.io/pass-cli/ |
...
| **python-ruff** | 0.16.4 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
| **python-sabyenc3** | 9.7.0 | C implementations of functions for use within SABnzbd | https://github.com/sabnzbd/sabctools |
...
| **ruff** | 0.16.4 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust** | 1.98.0 | Systems programming language focused on safety, speed and concurrency | https://www.rust-lang.org/ |
...
| **rust-docs** | 1.98.0 | Rust documentation | https://www.rust-lang.org/ |
| **rust-src** | 1.98.0 | Rust source code files | https://www.rust-lang.org/ |
| **rust-std-aarch64-linux-android** | 1.98.0 | Component files for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.98.0 | Component files for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.98.0 | Component files for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.98.0 | Component files for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip1** | 1.98.0 | Component files for target wasm32-wasip1 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip2** | 1.98.0 | Component files for target wasm32-wasip2 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip3** | 1.98.0 | Component files for target wasm32-wasip3 | https://www.rust-lang.org/ |
| **rust-std-wasm32v1-none** | 1.98.0 | Component files for target wasm32v1-none | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.98.0 | Component files for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.98.0 | Rust compiler development libs | https://www.rust-lang.org/ |
...
| **suitesparse** | 2:7.14.0 | A Suite of Sparse matrix packages. | https://github.com/DrTimothyAldenDavis/SuiteSparse |
| **suitesparse-static** | 2:7.14.0 | Static libraries for suitesparse | https://github.com/DrTimothyAldenDavis/SuiteSparse |
...
| **ttf-nerd-fonts-symbols** | 3.5.1 | Symbols-only font containing the Nerd Font icons | https://www.nerdfonts.com/ |
...
| **z3** | 5.1.0 | Z3 is a theorem prover from Microsoft Research | https://github.com/Z3Prover/z3 |
...
| **zellij** | 0.45.0 | A terminal workspace with batteries included | https://zellij.dev/ |
...
| **zola** | 0.23.4 | A fast static site generator in a single binary with everything built-in. | https://github.com/getzola/zola |
