...
| **cargo-binstall** | 1.20.0-1 | Tool to fetch and install precompiled musl-based static binaries from the Rust ecosystem | https://github.com/cargo-bins/cargo-binstall |
...
| **command-not-found** | 3.4.1-14 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **neovim-nightly** | 0.13.0~dev-767+gf876fd906e-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
