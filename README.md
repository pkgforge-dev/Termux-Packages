...
| **base16384** | 2.3.2 | Encode binary to printable utf16be | https://github.com/fumiama/base16384 |
...
| **bitcoin** | 29.0-1 | Bitcoin Core | https://bitcoincore.org/ |
...
| **chezmoi** | 2.65.0 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **clvk** | 0.0.20250821.115133 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
...
| **command-not-found** | 3.1-10 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **curl** | 8.15.0-1 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **emscripten** | 4.0.13-1 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 4.0.13-1 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 4.0.13-1 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 4.0.13-1 | Emscripten third party test suite files | https://emscripten.org |
...
| **fx** | 39.0.4 | Interactive JSON viewer on your terminal | https://github.com/antonmedv/fx |
...
| **gdk-pixbuf** | 2.42.12-4 | Library for image loading and manipulation | https://wiki.gnome.org/Projects/GdkPixbuf |
...
| **i2pd** | 2.57.0-1 | A full-featured C++ implementation of the I2P router | https://i2pd.website/ |
| **i2pd-static** | 2.57.0-1 | Static libraries for i2pd | https://i2pd.website/ |
...
| **jackett** | 0.22.2404 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jfrog-cli** | 2.78.8 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **libcurl** | 8.15.0-1 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.15.0-1 | Static libraries for libcurl | https://curl.se/ |
...
| **libjpeg-turbo** | 3.1.1-1 | Library for reading and writing JPEG image files | https://libjpeg-turbo.virtualgl.org |
| **libjpeg-turbo-progs** | 3.1.1-1 | Programs for manipulating JPEG files | https://libjpeg-turbo.virtualgl.org |
| **libjpeg-turbo-static** | 3.1.1-1 | Static libraries for libjpeg-turbo | https://libjpeg-turbo.virtualgl.org |
...
| **libssh** | 0.11.2-1 | Tiny C SSH library | https://www.libssh.org/ |
...
| **libtirpc** | 1.3.7 | Transport Independent RPC library | http://git.linux-nfs.org/?p=steved/libtirpc.git |
| **libtirpc-static** | 1.3.7 | Static libraries for libtirpc | http://git.linux-nfs.org/?p=steved/libtirpc.git |
...
| **libxml2** | 2.14.5-1 | Library for parsing XML documents | http://www.xmlsoft.org |
| **libxml2-python** | 2.14.5-1 | Python bindings for libxml2 | http://www.xmlsoft.org |
| **libxml2-python-static** | 2.14.5-1 | Static libraries for libxml2-python | http://www.xmlsoft.org |
| **libxml2-static** | 2.14.5-1 | Static libraries for libxml2 | http://www.xmlsoft.org |
| **libxml2-utils** | 2.14.5-1 | XML utilities | http://www.xmlsoft.org |
...
| **lsof** | 4.99.5-1 | Lists open files for running Unix processes | https://github.com/lsof-org/lsof |
| **lsof-static** | 4.99.5-1 | Static libraries for lsof | https://github.com/lsof-org/lsof |
...
| **monero** | 0.18.4.2-1 | A private, secure, untraceable, decentralised digital currency | https://getmonero.org/ |
...
| **neovim** | 0.11.4 | Ambitious Vim-fork focused on extensibility and agility (nvim) | https://neovim.io/ |
...
| **ngspice** | 45 | A mixed-level/mixed-signal circuit simulator | https://ngspice.sourceforge.net/ |
...
| **nushell** | 0.106.1-1 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **oh-my-posh** | 26.20.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **postgis** | 3.6.0 | Spatial database extender for PostgreSQL object-relational database | https://postgis.net |
...
| **python-ruff** | 0.12.11 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **ruff** | 0.12.11 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **sing-box** | 1.12.4 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **syncthing** | 2.0.4 | Decentralized file synchronization | https://syncthing.net/ |
| **sysprop** | 13.0.0.15-8 | Generates cpp / java sysprop | https://android.googlesource.com/platform/system/tools/sysprop |
...
| **tree-sitter** | 0.25.8-1 | An incremental parsing system for programming tools | https://github.com/tree-sitter/tree-sitter |
...
| **tree-sitter-static** | 0.25.8-1 | Static libraries for tree-sitter | https://github.com/tree-sitter/tree-sitter |
...
| **uv** | 0.8.14 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vtm** | 2025.09.02 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://github.com/directvt/vtm |
