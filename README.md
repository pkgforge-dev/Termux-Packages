...
| **k9s** | 0.50.13 | Kubernetes CLI To Manage Your Clusters In Style! | https://k9scli.io |
...
| **uv** | 0.8.23 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
