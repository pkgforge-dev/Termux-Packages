...
| **aspnetcore-runtime-10.0** | 10.0.4 | ASP.NET Core 10.0 Runtime | https://dotnet.microsoft.com/en-us/ |
...
| **aspnetcore-runtime-dbg-10.0** | 10.0.4 | ASP.NET Core 10.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
...
| **aspnetcore-targeting-pack-10.0** | 10.0.4 | ASP.NET Core 10.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
...
| **atuin** | 18.12.1-1 | Magical shell history | https://atuin.sh/ |
...
| **binaryen** | 127 | Binaryen is a compiler and toolchain infrastructure library for WebAssembly | https://github.com/WebAssembly/binaryen |
...
| **ccache** | 4.13.1 | Compiler cache for fast recompilation of C/C++ code | https://ccache.samba.org |
...
| **command-not-found** | 3.4.1 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **dotnet-apphost-pack-10.0** | 10.0.4 | .NET 10.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
...
| **dotnet-host-10.0** | 10.0.4 | .NET 10.0 Host | https://dotnet.microsoft.com/en-us/ |
...
| **dotnet-hostfxr-10.0** | 10.0.4 | .NET 10.0 Host Resolver | https://dotnet.microsoft.com/en-us/ |
...
| **dotnet-runtime-10.0** | 10.0.4 | .NET 10.0 Runtime | https://dotnet.microsoft.com/en-us/ |
...
| **dotnet-runtime-dbg-10.0** | 10.0.4 | .NET 10.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
...
| **dotnet-sdk-10.0** | 10.0.4 | .NET 10.0 SDK | https://dotnet.microsoft.com/en-us/ |
...
| **dotnet-sdk-dbg-10.0** | 10.0.4 | .NET 10.0 SDK Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
...
| **dotnet-targeting-pack-10.0** | 10.0.4 | .NET 10.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
...
| **dotnet-templates-10.0** | 10.0.4 | .NET 10.0 Templates | https://dotnet.microsoft.com/en-us/ |
...
| **dotnet10.0** | 10.0.4 | .NET 10.0 | https://dotnet.microsoft.com/en-us/ |
...
| **duckdb** | 1.5.0 | DuckDB Command Line Interface (CLI) shell | https://duckdb.org/ |
...
| **gdu** | 5.34.0 | Fast disk usage analyzer with console interface written in Go | https://github.com/dundee/gdu |
...
| **gh** | 2.88.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **graphviz** | 14.1.3 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 14.1.3 | Static libraries for graphviz | https://www.graphviz.org/ |
...
| **haproxy** | 3.3.5 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
| **harfbuzz** | 13.1.0 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 13.1.0 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 13.1.0 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **libc++utilities** | 5.33.0 | Useful C++ classes and routines such as argument parser, IO and conversion utilities | https://github.com/Martchus/cpp-utilities |
...
| **libduckdb** | 1.5.0 | An in-process SQL OLAP database management system | https://duckdb.org/ |
| **libduckdb-static** | 1.5.0 | Static libraries for libduckdb | https://duckdb.org/ |
...
| **libsqlite** | 3.52.0-1 | Library implementing a self-contained and transactional SQL database engine | https://www.sqlite.org |
| **libsqlite-static** | 3.52.0-1 | Static libraries for libsqlite | https://www.sqlite.org |
| **libsqlite-tcl** | 3.52.0-1 | tcl bindings for SQLite | https://www.sqlite.org |
...
| **libxml2** | 2.15.2-1 | Library for parsing XML documents | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
| **libxml2-python** | 2.15.2-1 | Python bindings for libxml2 | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
| **libxml2-utils** | 2.15.2-1 | XML utilities | https://gitlab.gnome.org/GNOME/libxml2/-/wikis/home |
...
| **lilypond** | 2.24.4-5 | A music engraving program | https://lilypond.org/ |
...
| **lowdown** | 3.0.0 | Markdown utilities and library (fork of hoedown -> sundown -> libsoldout) | https://kristaps.bsd.lv/lowdown |
| **lowdown-static** | 3.0.0 | Static libraries for lowdown | https://kristaps.bsd.lv/lowdown |
...
| **moor** | 2.11.1 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **neovim-nightly** | 0.12.0~dev-2536+gb897e81b30-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **nginx** | 1.29.6 | Lightweight HTTP server | https://www.nginx.org |
...
| **oh-my-posh** | 29.8.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **oxfmt** | 1.52.0 | Oxc JavaScript formatter | https://oxc.rs/ |
| **oxlint** | 1.52.0 | Oxc JavaScript linter | https://oxc.rs/ |
...
| **profanity** | 0.16.0-1 | Profanity is a console based XMPP client written in C using ncurses and libstrophe, inspired by Irssi | https://profanity-im.github.io |
...
| **pv** | 1.10.4 | Terminal-based tool for monitoring the progress of data through a pipeline | https://www.ivarch.com/programs/pv.shtml |
...
| **rust-analyzer** | 20260309 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **shfmt** | 3.13.0 | A shell parser and formatter | https://github.com/mvdan/sh |
...
| **swi-prolog** | 10.1.4-1 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **topgrade** | 17.0.0 | Upgrade all the things | https://github.com/topgrade-rs/topgrade/ |
...
| **vim** | 9.2.0100-2 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **xxd** | 9.2.0100-2 | Hexdump utility from vim | https://www.vim.org |
