...
| **onnxruntime** | 1.25.1 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **python-onnxruntime** | 1.25.1 | Cross-platform, high performance ML inferencing and training accelerator (Python bindings) | https://onnxruntime.ai/ |
...
| **railway-cli** | 4.56.1 | This is the command line interface for Railway | https://railway.app |
...
| **turbo** | 2.9.10 | High-performance build system for JS/TS | https://turborepo.dev/ |
...
| **uv** | 0.11.11 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
