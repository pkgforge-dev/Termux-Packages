...
| **awscli** | 2.36.16 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **ty** | 0.0.66 | An extremely fast Python type checker and language server, written in Rust | https://github.com/astral-sh/ty |
...
| **uv** | 0.12.1 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
