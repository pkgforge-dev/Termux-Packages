...
| **ani-cli** | 4.15 | A cli to browse and watch anime | https://github.com/pystardust/ani-cli |
...
| **at-spi2-core** | 2.60.5-1 | Assistive Technology Service Provider Interface (AT-SPI) | https://wiki.gnome.org/Accessibility |
...
| **awscli** | 2.36.10 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **bear** | 4.1.5 | Bear is a tool that generates a compilation database for clang tooling. | https://github.com/rizsotto/Bear |
...
| **chezmoi** | 2.71.1 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **command-not-found** | 3.5.0-4 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **delve** | 1.27.0 | A debugger for the Go programming language | https://github.com/go-delve/delve |
...
| **dnscontrol** | 4.44.1 | Infrastructure as code for DNS! | https://github.com/StackExchange/dnscontrol |
...
| **docker-compose** | 5.3.1-1 | Compose is a tool for defining and running multi-container Docker applications. | https://github.com/docker/compose |
...
| **dua** | 2.39.0 | View disk space usage and delete unwanted data, fast | https://github.com/Byron/dua-cli |
...
| **ffmpeg** | 8.1.2-1 | Tools and libraries to manipulate a wide range of multimedia formats and protocols | https://ffmpeg.org |
...
| **forgejo** | 16.0.1 | Forgejo is a self-hosted lightweight software forge. | https://forgejo.org/ |
...
| **fresh-editor** | 0.4.5 | Text editor for your terminal: easy, powerful and fast | https://getfresh.dev/ |
...
| **glab-cli** | 1.110.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
| **gleam** | 1.18.0 | A friendly language for building type-safe, scalable systems! | https://gleam.run |
...
| **haproxy** | 3.4.2 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
...
| **httrack** | 3.49.14 | It allows you to download a World Wide Web site from the Internet | http://www.httrack.com |
| **httrack-data** | 3.49.14 | Platform-independent data for httrack | http://www.httrack.com |
| **httrack-static** | 3.49.14 | Static libraries for httrack | http://www.httrack.com |
...
| **hwdata** | 0.409 | Database of hardware identification and configuration data | https://github.com/vcrhonek/hwdata |
...
| **jackett** | 0.24.2267 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jfrog-cli** | 2.116.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **keychain** | 3.0.1 | Keychain manager for ssh-agent and gpg-agent | https://kernel-seeds.org/projects/keychain/ |
...
| **libmicrohttpd** | 1.0.8 | A small C library that is supposed to make it easy to run an HTTP server as part of another application | http://www.gnu.org/software/libmicrohttpd/ |
| **libmicrohttpd-static** | 1.0.8 | Static libraries for libmicrohttpd | http://www.gnu.org/software/libmicrohttpd/ |
...
| **lux-cli** | 0.39.6 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **moor** | 2.15.2 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **nano** | 9.1 | Small, free and friendly text editor | https://www.nano-editor.org/ |
...
| **neovim-nightly** | 0.13.0~dev-1158+g1eba3a75da-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **npm** | 11.18.0 | The package manager for JavaScript | https://docs.npmjs.com/cli/ |
...
| **oh-my-posh** | 29.37.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **pocketbase** | 0.39.9 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **python-pip** | 26.1.2-1 | The PyPA recommended tool for installing Python packages | https://pip.pypa.io/ |
...
| **python-ruff** | 0.16.0 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **ruff** | 0.16.0 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust-analyzer** | 20260727 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **seerr** | 3.3.0 | A fork of Overseerr with focus on adding support for Jellyfin/Emby | https://github.com/seerr-team/seerr |
...
| **simdjson** | 4.6.5 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
...
| **storj-uplink** | 1.161.1 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **ty** | 0.0.64 | An extremely fast Python type checker and language server, written in Rust | https://github.com/astral-sh/ty |
...
| **uv** | 0.12.0 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vulkan-headers** | 1.4.357 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.357 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.357 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.357 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
...
| **wasm-component-ld** | 0.5.27 | Command line linker for creating WebAssembly components | https://github.com/bytecodealliance/wasm-component-ld |
