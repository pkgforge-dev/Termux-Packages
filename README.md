...
| **gap** | 4.14.0-2 | GAP is a system for computational discrete algebra, with particular emphasis on Computational Group Theory | https://www.gap-system.org/ |
| **gap-packages** | 4.14.0-2 | Packages for gap | https://www.gap-system.org/ |
...
| **glslang** | 15.4.0-2 | OpenGL and OpenGL ES shader front end and validator | https://github.com/KhronosGroup/glslang |
...
| **liblua52-static** | 5.2.4-13 | Static libraries for liblua52 | https://www.lua.org |
...
| **libnss** | 3.116 | Network Security Services (NSS) | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **libseat** | 0.9.1-2 | Reference implementation of a wayland compositor | https://sr.ht/~kennylevinsen/seatd/ |
...
| **lsd** | 1.1.5-2 | Next gen ls command | https://github.com/lsd-rs/lsd |
...
| **lua52** | 5.2.4-13 | Simple, extensible, embeddable programming language | https://www.lua.org |
...
| **miniserve** | 0.31.0-1 | Tool to serve files and dirs over HTTP | https://github.com/svenstaro/miniserve |
...
| **mono** | 6.14.1-1 | Framework Mono | https://gitlab.winehq.org/mono/mono |
| **mono-libs** | 6.14.1-1 | Platform-independent libraries for mono | https://gitlab.winehq.org/mono/mono |
| **mono-static** | 6.14.1-1 | Static libraries for mono | https://gitlab.winehq.org/mono/mono |
...
| **moor** | 2.1.1 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moor |
...
| **mpv** | 0.40.0-1 | Command-line media player | https://mpv.io/ |
...
| **mu** | 1.12.12-1 | Maildir indexer/searcher and Emacs client (mu4e) | https://www.djcbsoftware.nl/code/mu/ |
...
| **music-file-organizer** | 1.0.4-9 | Organizer of audio files into directories based on metadata tags | https://git.zx2c4.com/music-file-organizer/about/ |
...
| **navidrome** | 0.58.0-1 | 🎧☁️ Modern Music Server and Streamer compatible with Subsonic/Airsonic | https://www.navidrome.org/ |
...
| **ndk-multilib** | 28c-1 | Multilib binaries for cross-compilation | https://developer.android.com/tools/sdk/ndk/index.html |
| **ndk-multilib-native-static** | 28c-1 | Install native static libs from NDK | https://developer.android.com/tools/sdk/ndk/index.html |
| **ndk-multilib-native-stubs** | 28c-1 | Install native stubs for shared libs from NDK | https://developer.android.com/tools/sdk/ndk/index.html |
...
| **netcat-openbsd** | 1.229-1-4 | TCP/IP swiss army knife. OpenBSD variant. | https://packages.debian.org/sid/netcat-openbsd |
...
| **nethack** | 3.6.7-1 | Dungeon crawl game | http://www.nethack.org/ |
...
| **nss-utils** | 3.116 | Tools for NSS | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **ocl-icd** | 2.3.3-2 | OpenCL ICD Loader | https://github.com/OCL-dev/ocl-icd |
...
| **oh-my-posh** | 26.23.2 | A prompt theme engine for any shell. | https://ohmyposh.dev |
| **okc-agents** | 0.1.2-1 | OpenKeychain agents for GnuPG and OpenSSH | https://github.com/DDoSolitary/okc-agents |
...
| **openscad** | 2021.01-5 | The programmers solid 3D CAD modeller (headless build) | https://openscad.org/ |
...
| **osslsigncode** | 2.10-1 | OpenSSL based Authenticode signing for PE/MSI/Java CAB files | https://github.com/mtrojnar/osslsigncode |
...
| **panda3d** | 1.10.15-1 | A framework for 3D rendering and game development for Python and C++ programs | https://www.panda3d.org/ |
| **panda3d-samples** | 1.10.15-1 | Python sample programs that use Panda3D | https://www.panda3d.org/ |
| **panda3d-static** | 1.10.15-1 | Static libraries for panda3d | https://www.panda3d.org/ |
...
| **pastel** | 0.10.0-1 | A command-line tool to generate, analyze, convert and manipulate colors | https://github.com/sharkdp/pastel |
...
| **peaclock** | 0.4.3-8 | A responsive and customizable clock, timer, and stopwatch for the terminal. | https://github.com/octobanana/peaclock |
...
| **php-apache-ldap** | 8.4.2-3 | LDAP module for PHP/Apache | https://php.net |
| **php-apache-opcache** | 8.4.2-3 | OPcache module for PHP/Apache | https://php.net |
| **php-apache-pgsql** | 8.4.2-3 | PostgreSQL modules for PHP/Apache | https://php.net |
| **php-apache-sodium** | 8.4.2-3 | Sodium module for PHP/Apache | https://php.net |
| **php-apcu** | 5.1.27 | APCu - APC User Cache | http://php.net/apcu |
| **php-fpm** | 8.4.2-3 | FastCGI Process Manager for PHP | https://php.net |
| **php-gd** | 8.4.2-3 | gd module for PHP | https://php.net |
| **php-imagick** | 3.8.0-1 | The Imagick PHP extension | https://github.com/Imagick/imagick |
| **php-ldap** | 8.4.2-3 | LDAP module for PHP | https://php.net |
| **php-pgsql** | 8.4.2-3 | PostgreSQL modules for PHP | https://php.net |
| **php-psr** | 1.2.0-4 | PHP extension providing the accepted PSR interfaces | https://github.com/jbboehr/php-psr |
| **php-redis** | 6.2.0-1 | PHP extension for interfacing with Redis | https://github.com/phpredis/phpredis |
| **php-sodium** | 8.4.2-3 | Sodium module for PHP | https://php.net |
| **php-zephir-parser** | 1.7.0-1 | The Zephir Parser delivered as a C extension for the PHP language | https://github.com/phalcon/php-zephir-parser |
| **phpmyadmin** | 5.2.2 | A PHP tool for administering MySQL and MariaDB databases | https://www.phpmyadmin.net |
| **pianobar** | 2024.12.21-1 | pianobar is a free/open-source, console-based client for the personalized online radio Pandora. | https://6xq.net/pianobar/ |
...
| **pingme** | 0.2.6-4 | A small utility which can be called from anywhere to send a message with particular information | https://github.com/kha7iq/pingme |
...
| **pipewire** | 1.2.7-1 | A server and user space API to deal with multimedia pipelines | https://pipewire.org/ |
...
| **ptex** | 2.4.3-1 | Per-Face Texture Mapping for Production Rendering | https://github.com/wdas/ptex |
| **ptex-static** | 2.4.3-1 | Static libraries for ptex | https://github.com/wdas/ptex |
...
| **pv** | 1.9.34-1 | Terminal-based tool for monitoring the progress of data through a pipeline | https://www.ivarch.com/programs/pv.shtml |
...
| **pygobject** | 3.54.1 | Python package which provides bindings for GObject based libraries | https://pygobject.gnome.org/ |
...
| **python-bcrypt** | 4.3.0-1 | Acceptable password hashing for your software and your servers | https://github.com/pyca/bcrypt |
| **python-brotli** | 1.1.0-4 | lossless compression algorithm and format (Python bindings) | https://github.com/google/brotli |
...
| **python-onnxruntime** | 1.22.2-3 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **python-torchaudio** | 2.6.0-1 | Data manipulation and transformation for audio signal processing, powered by PyTorch | https://github.com/pytorch/audio |
...
| **qpdf-static** | 12.2.0-1 | Static libraries for qpdf | http://qpdf.sourceforge.net |
...
| **quickjs** | 1:20250426-1 | QuickJS is a small and embeddable Javascript engine | https://bellard.org/quickjs/ |
...
| **railway-cli** | 4.8.0 | This is the command line interface for Railway | https://railway.app |
...
| **rdrview** | 1:0.1.4-1 | Command line tool to extract the main content from a webpage | https://github.com/eafer/rdrview |
| **re2c** | 4.3-1 | Lexer generator for C, C++ and Go. | https://re2c.org/ |
...
| **remind** | 1:06.01.00 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
