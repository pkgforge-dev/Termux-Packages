...
| **command-not-found** | 2.4.0-79 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **glib-cross** | 2.84.2 | glib for host (NOT for Termux) | https://developer.gnome.org/glib/ |
...
| **haproxy** | 3.2.0 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
...
| **helm-ls** | 0.4.0 | Language server for Helm | https://github.com/mrjosh/helm-ls |
...
| **jackett** | 0.22.2008 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jfrog-cli** | 2.76.1 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **kubelogin** | 1.32.4 | A kubectl plugin for Kubernetes OpenID Connect (OIDC) authentication | https://github.com/int128/kubelogin |
...
| **libpluto** | 0.11.0 | Shared library for the Pluto interpreter | https://plutolang.github.io/ |
| **libpluto-static** | 0.11.0 | Static libraries for libpluto | https://plutolang.github.io/ |
...
| **moar** | 1.31.9 | A pager designed to just do the right thing without any configuration | https://github.com/walles/moar |
...
| **nano** | 8.4 | Small, free and friendly text editor | https://www.nano-editor.org/ |
...
| **oh-my-posh** | 26.6.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **plutolang** | 0.11.0 | A superset of Lua 5.4 with a focus on general-purpose programming. | https://plutolang.github.io/ |
...
| **tree-sitter** | 0.25.6-3 | An incremental parsing system for programming tools | https://github.com/tree-sitter/tree-sitter |
| **tree-sitter-c** | 0.24.1-1 | C grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-c |
...
| **tree-sitter-lua** | 0.4.0-1 | Lua grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-lua |
| **tree-sitter-lua-static** | 0.2.0 | Static libraries for tree-sitter-lua | https://github.com/tree-sitter-grammars |
| **tree-sitter-markdown** | 0.5.0-2 | Markdown grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-markdown |
| **tree-sitter-markdown-static** | 0.3.2 | Static libraries for tree-sitter-markdown | https://github.com/tree-sitter-grammars |
| **tree-sitter-parsers** | 0.0.4 | A metapackage that provides commonly used treesitter parsers | https://github.com/termux/termux-packages |
| **tree-sitter-query** | 0.6.1 | TS query grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-query |
| **tree-sitter-query-static** | 0.4.0-1 | Static libraries for tree-sitter-query | https://github.com/tree-sitter-grammars |
| **tree-sitter-static** | 0.25.6-3 | Static libraries for tree-sitter | https://github.com/tree-sitter/tree-sitter |
| **tree-sitter-vim** | 0.6.0-1 | Vimscript grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-vim |
| **tree-sitter-vim-static** | 0.6.0-1 | Static libraries for tree-sitter-vim | https://github.com/tree-sitter-grammars/tree-sitter-vim |
| **tree-sitter-vimdoc** | 4.0.0-1 | Tree-sitter parser for Vim help files | https://github.com/neovim/tree-sitter-vimdoc |
| **tree-sitter-vimdoc-static** | 4.0.0-1 | Static libraries for tree-sitter-vimdoc | https://github.com/neovim/tree-sitter-vimdoc |
...
| **uv** | 0.7.12 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vtm** | 2025.06.11 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
...
| **vulkan-headers** | 1.4.317 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.317 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.317 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.317 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
