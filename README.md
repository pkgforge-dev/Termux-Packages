...
| **awscli** | 2.35.9 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **biome2** | 2.5.0 | A toolchain for web projects, aimed to provide functionalities to maintain them. Biome offers formatter and linter, usable via CLI and LSP | https://biomejs.dev/ |
...
| **blk-utils** | 2.42.1-1 | Utilities for handling block device attributes | https://en.wikipedia.org/wiki/Util-linux |
...
| **curl** | 8.20.0 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **elixir** | 1.20.1 | Elixir is a dynamic, functional language designed for building scalable and maintainable applications | https://elixir-lang.org/ |
...
| **emscripten** | 6.0.0 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 6.0.0 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 6.0.0 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 6.0.0 | Emscripten third party test suite files | https://emscripten.org |
...
| **fastfetch** | 2.64.2 | A maintained, feature-rich and performance oriented, neofetch like system information tool | https://github.com/fastfetch-cli/fastfetch |
...
| **fdisk** | 2.42.1-1 | Utilities to manipulate disk partition tables | https://en.wikipedia.org/wiki/Util-linux |
...
| **fish** | 4.7.1-1 | The user-friendly command line shell | https://fishshell.com/ |
...
| **flyctl** | 0.4.59 | Command line tools for fly.io services | https://fly.io |
...
| **freecell-solver** | 6.16.0 | Freecell Solver is an open source library for automatically solving several variants of Solitaire/Patience card games, including Freecell. | https://fc-solve.shlomifish.org/ |
...
| **geth** | 1.17.3 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.17.3 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **glab-cli** | 1.103.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **gping** | 1.20.2 | Ping, but with a graph | https://github.com/orf/gping |
...
| **hcloud** | 1.65.0 | Hetzner Cloud command line client | https://github.com/hetznercloud/cli |
...
| **just** | 1.53.0 | A handy way to save and run project-specific commands | https://just.systems |
...
| **less** | 702-1 | Terminal pager program used to view the contents of a text file one screen at a time | https://www.greenwoodsoftware.com/less/ |
...
| **libblkid** | 2.42.1-1 | Block device identification library | https://en.wikipedia.org/wiki/Util-linux |
...
| **libcurl** | 8.20.0 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.20.0 | Static libraries for libcurl | https://curl.se/ |
...
| **libfdisk** | 2.42.1-1 | Library for manipulating disk partition tables | https://en.wikipedia.org/wiki/Util-linux |
...
| **libmount** | 2.42.1-1 | Library for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **libsmartcols** | 2.42.1-1 | Library for smart adaptive formatting of tabular data | https://en.wikipedia.org/wiki/Util-linux |
...
| **libuuid** | 2.42.1-1 | Library for handling universally unique identifiers | https://en.wikipedia.org/wiki/Util-linux |
...
| **lux-cli** | 0.33.1 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **mise** | 2026.6.12 | dev tools, env vars, task runner | https://mise.jdx.dev/ |
...
| **mount-utils** | 2.42.1-1 | Utilities for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **mympd** | 25.2.1 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **nano** | 9.0-1 | Small, free and friendly text editor | https://www.nano-editor.org/ |
...
| **neovim-nightly** | 0.13.0~dev-789+g259f1173e4-1 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **oh-my-posh** | 29.17.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **proot** | 5.1.107.80 | Emulate chroot, bind mount and binfmt_misc for non-root users | https://proot-me.github.io/ |
...
| **rtorrent** | 0.16.14 | Ncurses BitTorrent client based on libTorrent | https://rakshasa.github.io/rtorrent/ |
...
| **sing-box** | 1.13.13 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **storj-uplink** | 1.157.5 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **teleport-tsh** | 18.9.0 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **turbo** | 2.9.18 | High-performance build system for JS/TS | https://turborepo.dev/ |
...
| **ty** | 0.0.51 | An extremely fast Python type checker and language server, written in Rust | https://github.com/astral-sh/ty |
...
| **util-linux** | 2.42.1-1 | Miscellaneous system utilities | https://en.wikipedia.org/wiki/Util-linux |
| **util-linux-static** | 2.42.1-1 | Static libraries for util-linux | https://en.wikipedia.org/wiki/Util-linux |
| **uucp** | 1.07-2 | The standard UUCP package of the Free Software Foundation | https://www.airs.com/ian/uucp.html |
| **uuid-utils** | 2.42.1-1 | Utilities for handling universally unique identifiers | https://en.wikipedia.org/wiki/Util-linux |
| **uv** | 0.11.23 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vim** | 9.2.0650-1 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **wakatime-cli** | 2.21.0 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **xh** | 0.26.1 | A friendly and fast tool for sending HTTP requests | https://github.com/ducaale/xh |
...
| **xxd** | 9.2.0650-1 | Hexdump utility from vim | https://www.vim.org |
